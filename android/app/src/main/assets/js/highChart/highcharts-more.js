...
(function (z) {
  ...
  (function (a) {
    ...
    g(w.prototype, {
      ...
      setOptions: function (a) {
        this.options = h(this.defaultOptions, this.chart.angular ? { background: {} } : void 0, a);
      },
      render: function () {
        var a = this.options,
        ...
        this.updateCenter();
        if (b)
          for (b = u(b), a = Math.max(b.length, this.background.length || 0), d = 0; d < a; d++)
            b[d] && this.axis
              ? this.renderBackground(h(this.defaultBackgroundOptions, b[d]), d)
              : this.background[d] &&
                ((this.background[d] = this.background[d].destroy()), this.background.splice(d, 1));
      },
      renderBackground: function (a, b) {
        var d = 'animate',
          e = { class: 'highcharts-pane ' + (a.className || '') };
        this.chart.styledMode ||
          g(e, { fill: a.backgroundColor, stroke: a.borderColor, 'stroke-width': a.borderWidth });
        this.background[b] || ((this.background[b] = this.chart.renderer.path().add(this.group)), (d = 'attr'));
        this.background[b][d]({ d: this.axis.getPlotBandPath(a.from, a.to, a) }).attr(e);
      },
    ...
    a.radialAxisExtended ||
      ...
      (t = {
        ...
        getLinePath: function (l, n) {
          ...
          this.isCircular || void 0 !== n
            ? ((n = this.chart.renderer.symbols.arc(this.left + l[0], this.top + l[1], k, k, {
              ...
              (n.yBounds = [this.top + l[1] - k]))
            : ((n = this.postTranslate(this.angleRad, k)),
        ...
        beforeSetTickPositions: function () {
          if (
            (this.autoConnect =
              this.isCircular &&
              void 0 === p(this.userMax, this.options.max) &&
              c(this.endAngleRad - this.startAngleRad) === c(2 * Math.PI))
          )
        ...
        getPosition: function (l, n) {
          return this.postTranslate(
            this.isCircular ? this.translate(l) : this.angleRad,
            p(this.isCircular ? n : this.translate(l), this.center[2] / 2) - this.offset
          );
        },
        postTranslate: function (l, n) {
          ...
          return { x: f.plotLeft + k[0] + Math.cos(l) * n, y: f.plotTop + k[1] + Math.sin(l) * n };
        },
        getPlotBandPath: function (l, n, f) {
          ...
          'polygon' === this.options.gridLineInterpolation
            ? (k = this.getPlotLinePath(l).concat(this.getPlotLinePath(n, !0)))
            : ((l = Math.max(l, this.min)),
              (n = Math.min(n, this.max)),
              q || ((a[0] = this.translate(l)), (a[1] = this.translate(n))),
              (a = a.map(function (f) {
                v.test(f) && (f = (b(f, 10) * m) / 100);
                return f;
              })),
              'circle' !== f.shape && q
                ? ((l = c + this.translate(l)), (n = c + this.translate(n)))
                : ((l = -Math.PI / 2), (n = 1.5 * Math.PI), (d = !0)),
              (a[0] -= e),
              (a[2] -= e),
        ...
        getPlotLinePath: function (l, c) {
          var f = this,
            ...
            e;
          f.isCircular
            ? (e = ['M', k[0] + n.plotLeft, k[1] + n.plotTop, 'L', a.x, a.y])
            : 'circle' === f.options.gridLineInterpolation
            ? ((l = f.translate(l)), (e = f.getLinePath(0, l)))
            : (n.xAxis.forEach(function (k) {
                k.pane === f.pane && (b = k);
              }),
              (e = []),
              (l = f.translate(l)),
        ...
        getTitlePosition: function () {
          ...
          return {
            ...
            y: c.plotTop + l[1] - { high: 0.5, middle: 0.25, low: 0 }[f.align] * l[2] + (f.y || 0),
          };
        },
      }),
      w(x, 'init', function (l) {
        ...
        if (k) {
          if ((g(this, m ? q : t), (e = !b))) this.defaultRadialOptions = this.defaultRadialGaugeOptions;
      ...
      w(x, 'afterInit', function () {
        ...
        (c.angular && this.isXAxis) ||
          !f ||
          (!c.angular && !c.polar) ||
          ((this.angleRad = ((a.angle || 0) * Math.PI) / 180),
      ...
      w(d, 'afterGetLabelPosition', function (c) {
        ...
        a.isRadial &&
          ((b = a.getPosition(this.pos, a.center[2] / 2 + p(k.distance, -25))),
          'auto' === k.rotation
            ? f.attr({ rotation: v })
            : null === l &&
              (l = a.chart.renderer.fontMetrics(f.styles && f.styles.fontSize).b - f.getBBox().height / 2),
          null === e &&
            (a.isCircular
              ? (this.label.getBBox().width > (a.len * a.tickInterval) / (a.max - a.min) && (m = 0),
                (e = v > m && v < 180 - m ? 'left' : v > 180 + m && v < 360 - m ? 'right' : 'center'))
              : (e = 'center'),
            f.attr({ align: e })),
          (c.pos.x = b.x + k.x),
          (c.pos.y = b.y + l));
      ...
      e(m, 'getMarkPath', function (c, a, f, k, b, m, e) {
        var l = this.axis;
        l.isRadial
          ? ((c = l.getPosition(this.pos, l.center[2] / 2 + k)), (a = ['M', a, f, 'L', c.x, c.y]))
          : (a = c.call(this, a, f, k, b, m, e));
        return a;
      }));
  })(z);
  (function (a) {
      ...
      },
      {
        ...
        getGraphPath: function (a) {
          var c = [],
            b = [],
            e,
            v = p.area.prototype.getGraphPath,
            m,
            l,
            n;
          n = this.options;
          ...
          for (e = a.length; e--; )
            (m = a[e]),
              m.isNull ||
                ...
                k ||
                (a[e + 1] && !a[e + 1].isNull) ||
                b.push({ plotX: m.plotX, plotY: m.plotY, doCurve: !1 }),
              (l = {
              ...
              m.isNull ||
                ...
                b.push({ plotX: m.plotX, plotY: m.plotY, doCurve: !1 });
          a = v.call(this, a);
          d && (!0 === d && (d = 'left'), (n.step = { left: 'right', center: 'center', right: 'left' }[d]));
          c = v.call(this, c);
          b = v.call(this, b);
          n.step = d;
          n = [].concat(a, c);
            ...
            for (d = c; d--; )
              if ((m = a[d]))
                (l = f.inside ? m.plotHigh < m.plotLow : m.plotHigh > m.plotLow),
                  ...
                  (m.below = l),
                  n
                    ? f.align || (f.align = l ? 'right' : 'left')
                    : f.verticalAlign || (f.verticalAlign = l ? 'top' : 'bottom');
            ...
            for (d = c; d--; )
              if ((m = a[d]))
                (l = k.inside ? m.plotHigh < m.plotLow : m.plotHigh > m.plotLow),
                  (m.below = !l),
                  n
                    ? k.align || (k.align = l ? 'left' : 'right')
                    : k.verticalAlign || (k.verticalAlign = l ? 'bottom' : 'top');
  ...
  (function (a) {
    var w = a.seriesType;
    w('areasplinerange', 'arearange', null, { getPointSpline: a.seriesTypes.spline.prototype.getPointSpline });
  })(z);
  (function (a) {
    ...
    u(
      'columnrange',
      'arearange',
      x(w.column, w.arearange, { pointRange: null, marker: null, states: { hover: { halo: !1 } } }),
      {
        translate: function () {
          var a = this,
            d = a.yAxis,
          ...
          a.points.forEach(function (b) {
            ...
            v
              ? ((q = b.barX + c),
                (b.shapeType = 'path'),
                (b.shapeArgs = { d: a.polarArc(y + n, y, q, q + b.pointWidth) }))
              : ((f.height = n),
                (f.y = y),
                (b.tooltipPos = t.inverted
                  ? [d.len + d.pos - t.plotLeft - y - n / 2, e.len + e.pos - t.plotTop - f.x - f.width / 2, n]
                  : [e.left - t.plotLeft + f.x + f.width / 2, d.pos - t.plotTop + y + n / 2, n]));
          });
        },
        directTouch: !0,
      ...
      {},
      {
        translate: function () {
          ...
          a.points.forEach(function (b) {
            ...
            b.barX = k;
            b.pointWidth = v;
            b.tooltipPos = u.inverted
              ? [d.len + d.pos - u.plotLeft - n, a.xAxis.len - k - y, f]
              : [k + y, n + d.pos - u.plotTop, f];
            n = e + (b.total || b.y);
            ...
            u.inverted &&
              ...
              0 > b.y && (D = B + f + q));
            b.shapeType = 'path';
            b.shapeArgs = { x: h, y: x, width: r - h, height: f, d: ['M', h, x, 'L', r, x, g, D, t, D, 'Z'] };
          });
        },
      }
    );
      ...
      },
      {
        ...
        translate: function () {
          ...
          this.points.forEach(function (d) {
            ...
            w(k)
              ? ((k = (k / 180) * Math.PI), (C = Math.max(a.startAngleRad - k, Math.min(a.endAngleRad + k, C))))
              : !1 === b.wrap && (C = Math.max(a.startAngleRad, Math.min(a.endAngleRad, C)));
            C = (180 * C) / Math.PI;
            d.shapeType = 'path';
            d.shapeArgs = {
        ...
        drawPoints: function () {
          ...
          q
            ? q.animate({ translateX: c[0], translateY: c[1] })
            : ((a.pivot = m
                .circle(0, 0, g(v.radius, 5))
                .attr({ zIndex: 2 })
        ...
        animate: function (a) {
          ...
          a ||
            (b.points.forEach(function (a) {
              var c = a.graphic;
              c &&
                (c.attr({ rotation: (180 * b.yAxis.startAngleRad) / Math.PI }),
                c.animate({ rotation: a.shapeArgs.rotation }, b.options.animation));
            }),
            (b.animate = null));
        },
        render: function () {
        ...
        drawPoints: function () {
          ...
          a.points.forEach(function (r) {
            ...
            void 0 !== r.plotY &&
              ...
              t ||
                ((r.graphic = t = d.g('point').add(a.group)),
              ...
              (l = f + C + m),
              r.stem[p]({ d: ['M', l, c, 'L', l, q, 'M', l, e, 'L', l, g] }),
              y &&
                ((m = (r.box.strokeWidth() % 2) / 2),
                (e = Math.floor(e) + m),
                (c = Math.floor(c) + m),
                (f += m),
                (k += m),
                r.box[p]({ d: ['M', f, c, 'L', f, e, 'L', k, e, 'L', k, c, 'L', f, c, 'z'] })),
              F &&
                ((m = (r.whiskers.strokeWidth() % 2) / 2),
                (q += m),
                (g += m),
                (B = /%$/.test(F) ? (C * parseFloat(F)) / 100 : F / 2),
                r.whiskers[p]({ d: ['M', l - B, q, 'L', l + B, q, 'M', l - B, g, 'L', l + B, g] })),
              (v = Math.round(r.medianPlot)),
              (m = (r.medianShape.strokeWidth() % 2) / 2),
              (v += m),
              r.medianShape[p]({ d: ['M', f, v, 'L', k, v] }));
          });
        },
        setStackedPoints: w,
      }
  ...
  (function (a) {
    ...
    x(
      ...
      },
      {
        ...
        getColumnMetrics: function () {
          return (
            (this.linkedParent && this.linkedParent.columnMetrics) || g.column.prototype.getColumnMetrics.call(this)
          );
        },
      }
    );
      ...
      },
      {
            ...
            (f = d[c]),
              ...
              x
                ? E &&
                  ((r = E[c]),
                  'overlap' === x
                    ? ((e = r.threshold + r.total), (r.total -= A), (e = 0 <= A ? e : e - A))
                    : 0 <= A
                    ? ((e = r.threshold + r.posTotal), (r.posTotal -= A))
                    : ((e = r.threshold + r.negTotal), (r.negTotal -= A), (e -= A)),
                  f.isSum || (r.connectorThreshold = r.threshold + r.stackTotal),
                  b.reversed ? ((y = 0 <= A ? e - A : e + A), (A = e)) : ((y = e), (A = e - A)),
                  (f.below = y <= g(w, 0)),
                  (k.y = b.translate(y, 0, 1, 0, 1)),
                  (k.height = Math.abs(k.y - b.translate(A, 0, 1, 0, 1))))
                : ((e = Math.max(h, h + A) + r[0]),
                  (k.y = b.translate(e, 0, 1, 0, 1)),
                  f.isSum
                    ? ((k.y = b.translate(r[1], 0, 1, 0, 1)),
                      (k.height = Math.min(b.translate(r[0], 0, 1, 0, 1), b.len) - k.y))
                    : f.isIntermediateSum
                    ? (0 <= A ? ((y = r[1] + q), (A = q)) : ((y = q), (A = r[1] + q)),
                      b.reversed && ((y ^= A), (A ^= y), (y ^= A)),
                      (k.y = b.translate(y, 0, 1, 0, 1)),
                      (k.height = Math.abs(k.y - Math.min(b.translate(A, 0, 1, 0, 1), b.len))),
                      (q += r[1]))
                    : ((k.height =
                        0 < y
                          ? b.translate(h, 0, 1, 0, 1) - k.y
                          : b.translate(h, 0, 1, 0, 1) - b.translate(h - y, 0, 1, 0, 1)),
                      (h += y),
                      (f.below = h < g(w, 0))),
                  0 > k.height && ((k.y += k.height), (k.height *= -1))),
              (f.plotY = k.y = Math.round(k.y) - (this.borderWidth % 2) / 2),
              (k.height = Math.max(Math.round(k.height), 0.001)),
              (f.yBottom = k.y + k.height),
              k.height <= p && !f.isNull
                ? ((k.height = p), (k.y -= u), (f.plotY = k.y), (f.minPointLengthOffset = 0 > f.y ? -u : u))
                : (f.isNull && (k.width = 0), (f.minPointLengthOffset = 0)),
        ...
        processData: function (a) {
          ...
          for (t = h = v = q = r = 0; t < k; t++)
            (g = l[t]),
              ...
              'sum' === g || f.isSum
                ? (l[t] = w(h))
                : 'intermediateSum' === g || f.isIntermediateSum
                ? ((l[t] = w(v)), (v = 0))
                : ((h += g), (v += g)),
              (q = Math.min(h, q)),
              (r = Math.max(h, r));
        ...
        getCrispPath: function () {
          ...
          for (w = 1; w < c; w++) {
            ...
            g &&
              ((g = g[w - 1]),
              h
                ? ((g = g.connectorThreshold), (t = Math.round(b.translate(g, 0, 1, 0, 1) + (e ? t : 0)) - d))
                : (t = p.y + r.minPointLengthOffset + f - d),
        ...
        setStackedPoints: function () {
          ...
          if (this.visible || !this.chart.options.chart.ignoreHiddenSeries)
            for (b[k] || (b[k] = {}), b = b[k], k = 0; k < h; k++)
              (g = e[k]),
                b[g] || (b[g] = { negTotal: 0, posTotal: 0, total: 0, stackTotal: 0, threshold: 0, stackState: [d] }),
                (g = b[g]),
                (q = this.yData[k]),
                ...
                (q = g.posTotal),
                (r = g.negTotal),
                t && t.isIntermediateSum ? ((d ^= f), (f ^= d), (d ^= f)) : t && t.isSum && (d = c),
                (g.stackTotal = q + r),
  ...
  (function (a) {
    ...
    a.BubbleLegend.prototype = {
      ...
      setOptions: function () {
        var a = this,
          ...
          l = a.legend.baseline,
          g = { 'z-index': d.zIndex, 'stroke-width': d.borderWidth },
          m = { 'z-index': d.zIndex, 'stroke-width': d.connectorWidth },
          h = a.getLabelStyles(),
          n = e.options.marker.fillOpacity,
          q = a.chart.styledMode;
        b.forEach(function (f, k) {
          q ||
            ((g.stroke = t(f.borderColor, d.borderColor, e.color)),
          ...
          b[k] = c(b[k], { center: b[0].radius - b[k].radius + l });
          q || c(!0, b[k], { bubbleStyle: c(!1, g), connectorStyle: c(!1, m), labelStyle: h });
        });
      },
      ...
      render: function () {
        ...
        a.symbols || (a.symbols = { connectors: [], bubbleItems: [], labels: [] });
      ...
      renderRange: function (a) {
        ...
        d.bubbleItems.push(
          f
            .circle(q, l + ((v % 1 ? 1 : 0.5) - (c % 2 ? 0 : 0.5)), g)
            .attr(p ? {} : a.bubbleStyle)
            .addClass(
              (p ? 'highcharts-color-' + this.options.seriesIndex + ' ' : '') +
        ...
        d.connectors.push(
          f
            .path(f.crispLine(['M', q, v, 'L', q + m, v], b.connectorWidth))
        ...
        a.chart.series.forEach(function (a) {
          a.isBubble &&
            ...
            e.length &&
              ((g = t(
                a.options.zMin,
                Math.min(g, Math.max(l(e), !1 === a.options.displayNegative ? a.options.zThreshold : -Number.MAX_VALUE))
              )),
              (m = t(a.options.zMax, Math.max(m, n(e))))));
        });
        k = g === m ? [{ value: m }] : [{ value: g }, { value: (g + m) / 2 }, { value: m, autoRanges: !0 }];
    ...
    h(a.Legend, 'afterGetAllItems', function (b) {
      ...
      c &&
        c.ranges &&
        c.ranges.length &&
        (d.ranges.length && (d.autoRanges = !!d.ranges[0].autoRanges), this.destroyItem(c));
      0 <= e &&
        f.enabled &&
        d.enabled &&
        ((d.seriesIndex = e),
    ...
    x.prototype.retranslateItems = function (a) {
      ...
      this.allItems.forEach(function (l, k) {
        ...
        if ((d = l.movementX) || (f && l.ranges))
          (d = f ? b - l.options.maxSize / 2 : b + d), l.legendGroup.attr({ translateX: d });
        k > a[e].step && e++;
        l.legendGroup.attr({ translateY: Math.round(c + a[e].height / 2) });
    ...
    h(w, 'legendItemClick', function () {
      ...
      c &&
        ...
        c.bubbleLegend.visible !== a && (c.update({ bubbleLegend: { enabled: a } }), (c.bubbleLegend.visible = a)),
        (this.visible = b));
    });
    u(g.prototype, 'drawChartBox', function (a, b, c) {
      var d = this.legend,
        ...
        l;
      d && d.options.enabled && d.bubbleLegend && d.options.bubbleLegend.autoRanges && f
        ? ((l = d.bubbleLegend.options),
        ...
        : (a.call(this, b, c),
          d && d.options.enabled && d.bubbleLegend && (d.render(), d.retranslateItems(d.getLinesHeights())));
    });
  })(z);
  (function (a) {
    var w = a.arrayMax,
      ...
      },
      {
        ...
        getRadius: function (a, b, c, d, f) {
          ...
          e.sizeByAbsoluteValue &&
            null !== f &&
            ((f = Math.abs(f - g)), (m = Math.max(b - g, Math.abs(a - g))), (a = 0));
          u(f)
            ? f < a
              ? (c = c / 2 - 1)
              : ((a = 0 < m ? (f - a) / m : 0.5),
                l && 0 <= a && (a = Math.sqrt(a)),
                (c = Math.ceil(c + a * (d - c)) / 2))
            : (c = null);
          return c;
        },
        animate: function (a) {
          !a &&
            ...
            (this.points.forEach(function (a) {
              ...
              b &&
                b.width &&
                ((c = { x: b.x, y: b.y, width: b.width, height: b.height }),
        ...
        translate: function () {
          ...
          for (b = c.length; b--; )
            (d = c[b]),
              (e = f ? f[b] : 0),
              u(e) && e >= this.minPxSize / 2
                ? ((d.marker = a.extend(d.marker, { radius: e, width: 2 * e, height: 2 * e })),
                  (d.dlBox = { x: d.plotX - e, y: d.plotY - e, width: 2 * e, height: 2 * e }))
    ...
    g.prototype.beforePadding = function () {
      ...
      this.series.forEach(function (e) {
        var f = e.options;
        !e.bubblePadding ||
          (!e.visible && g.options.chart.ignoreHiddenSeries) ||
          ...
          k &&
            ...
            e.length &&
              ((r = b(
                f.zMin,
                Math.min(r, Math.max(x(e), !1 === f.displayNegative ? f.zThreshold : -Number.MAX_VALUE))
              )),
        ...
        if (0 < J)
          for (; d--; )
            u(b[d]) &&
              c.dataMin <= b[d] &&
              b[d] <= c.dataMax &&
              ((e = a.radii[d]), (h = Math.min((b[d] - t) * H - e, h)), (f = Math.max((b[d] - t) * H + e, f)));
      });
      D.length &&
        0 < J &&
        !this.isLog &&
        ...
        translate: function () {
          ...
          for (e = 0; e < g.length; e++)
            g[e][3] === p &&
              ...
              (b.marker = a.extend(b.marker, { radius: d, width: 2 * d, height: 2 * d })));
        },
        checkOverlap: function (a, h) {
          var g = a[0] - h[0],
            p = a[1] - h[1];
          return -0.001 > Math.sqrt(g * g + p * p) - Math.abs(a[2] + h[2]);
        },
        ...
        placeBubbles: function (a) {
          ...
          for (q = 2; q < c.length; q++)
            (c[q][2] = c[q][2] || 1),
              ...
              g(a, p[b][0])
                ? (p.push([]), (e = 0), p[b + 1].push(u(p[b][d], p[b][0], c[q])), b++, (d = 0))
                : 1 < b && p[b - 1][e + 1] && g(a, p[b - 1][e + 1])
                ? (e++, p[b].push(u(p[b][d], p[b - 1][e], c[q])), d++)
                : (d++, p[b].push(a));
          this.chart.stages = p;
  ...
  (function (a) {
    ...
    a.polarExtended ||
      ...
      (u.getConnectors = function (a, d, e, c) {
        ...
        g = { rightContX: l, rightContY: f, leftContX: m, leftContY: h, plotX: g, plotY: b };
      ...
      (u.toXY = function (a) {
        ...
        this.kdByAngle
          ? ((e = ((c / Math.PI) * 180 + this.xAxis.pane.options.startAngle) % 360),
            0 > e && (e += 360),
            (a.clientX = e))
          : (a.clientX = a.plotX);
      }),
      g.spline &&
        (h(g.spline.prototype, 'getPointSpline', function (a, d, e, c) {
          this.chart.polar
            ? c
              ? ((a = this.getConnectors(d, c, !0, this.connectEnds)),
                (a = [
                  'C',
      ...
      a.addEvent(
        ...
        function () {
          ...
          if (b.polar) {
            ...
            if (!this.preventPostTranslate) for (d = this.points, e = d.length; e--; ) this.toXY(d[e]);
      ...
      h(u, 'getGraphPath', function (a, d) {
        ...
        if (this.chart.polar) {
          ...
          !1 !== this.options.connectEnds &&
            void 0 !== g &&
            ((this.connectEnds = !0), d.splice(d.length, 0, d[g]), (h = !0));
          d.forEach(function (a) {
      ...
      (x = function (a, d) {
        ...
        b.polar
          ? b.renderer.isSVG &&
            (!0 === c && (c = {}),
            d
              ? ((a = { translateX: p[0] + m, translateY: p[1] + l, scaleX: 0.001, scaleY: 0.001 }),
                g.attr(a),
                h && h.attr(a))
              : ((a = { translateX: m, translateY: l, scaleX: 1, scaleY: 1 }),
                g.animate(a, c),
                h && h.animate(a, c),
                (this.animate = null)))
          : a.call(this, d);
      ...
      h(u, 'animate', x),
      g.column &&
        ((g = g.column.prototype),
        (g.polarArc = function (a, d, e, c) {
          var b = this.xAxis.center,
            g = this.yAxis.len;
          return this.chart.renderer.symbols.arc(b[0], b[1], g - d, null, { start: e, end: c, innerR: g - w(a, g) });
        }),
        h(g, 'animate', x),
        ...
        h(g, 'alignDataLabel', function (a, d, e, c, g, h) {
          this.chart.polar
            ? ((a = (d.rectPlotX / Math.PI) * 180),
              null === c.align && (c.align = 20 < a && 160 > a ? 'left' : 200 < a && 340 > a ? 'right' : 'center'),
              null === c.verticalAlign &&
                (c.verticalAlign = 45 > a || 315 < a ? 'bottom' : 135 < a && 225 > a ? 'top' : 'middle'),
              u.alignDataLabel.call(this, d, e, c, g, h))
            : a.call(this, d, e, c, g, h);
        })),
      ...
      (a.SVGRenderer.prototype.clipCircle = function (b, d, e) {
        var c = a.uniqueKey(),
          g = this.createElement('clipPath').attr({ id: c }).add(this.defs);
