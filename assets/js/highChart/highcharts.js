...
(function (N, I) {
  'object' === typeof module && module.exports
    ? ((I['default'] = I), (module.exports = N.document ? I(N) : I))
  ...
  (function (a) {
    ...
    a.Fx.prototype = {
      ...
      run: function (k, c, p) {
        ...
        k !== c || this.elem['forceAnimate:' + this.prop]
      ...
      step: function (k) {
        ...
        v.attr && !v.element
          ...
          ? ((this.now = this.end),
            ...
            p && w && w.call(v),
            (k = !1))
          : ((this.pos = t.easing((c - this.startTime) / r)),
    ...
    a.attr = function (k, c, p) {
      ...
      a.isString(c)
        ? a.defined(p)
          ? k.setAttribute(c, p)
          : k && k.getAttribute && ((t = k.getAttribute(c)) || 'class' !== c || (t = k.getAttribute(c + 'Name')))
        : a.defined(c) &&
          a.isObject(c) &&
    ...
    a.pick = function () {
      var a = arguments,
        ...
        p,
        t = a.length;
      for (c = 0; c < t; c++) if (((p = a[c]), void 0 !== p && null !== p)) return p;
    };
    a.css = function (k, c) {
    ...
    a.datePropsToTimestamps = function (k) {
      a.objectEach(k, function (c, p) {
        a.isObject(c) && 'function' === typeof c.getTime
          ? (k[p] = c.getTime())
          : (a.isObject(c) || a.isArray(c)) && a.datePropsToTimestamps(c);
      });
    };
    a.formatSingle = function (k, c, p) {
      ...
      /f$/.test(k)
        ? ((p = (p = k.match(t)) ? p[1] : -1),
          null !== c && (c = a.numberFormat(c, p, v.decimalPoint, -1 < k.indexOf(',') ? v.thousandsSep : '')))
        : (c = (p || a.time).dateFormat(k, c));
      return c;
    };
    ...
    a.normalizeTickInterval = function (k, c, p, t, v) {
      ...
      w = k / p;
      c ||
        ((c = v ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
        !1 === t &&
          (1 === p
      ...
      for (
        t = 0;
        t < c.length && !((r = c[t]), (v && r * p >= k) || (!v && w <= (c[t] + (c[t + 1] || c[t])) / 2));
        t++
      );
      return (r = a.correctFloat(r * p, -Math.round(Math.log(0.001) / Math.LN10)));
    };
    ...
    a.numberFormat = function (k, c, p, t) {
      ...
      -1 === c
        ...
        ? c &&
          ...
          ((r = c + +e[1]),
          0 <= r
            ? ((e[0] = (+e[0]).toExponential(r).split('e')[0]), (c = r))
            : ((e[0] = e[0].split('.')[0] || 0), (k = 20 > c ? (e[0] * Math.pow(10, e[1])).toFixed(c) : 0), (e[1] = 0)))
        : (c = 2);
      ...
      if ('width' === c)
        return Math.max(
          ...
          Math.min(
            k.offsetWidth,
            k.scrollWidth,
            k.getBoundingClientRect && 'none' === a.getStyle(k, 'transform', !1)
              ? Math.floor(k.getBoundingClientRect().width)
              : Infinity
          ) -
            a.getStyle(k, 'padding-left') -
            a.getStyle(k, 'padding-right')
        );
      if ('height' === c)
        return Math.max(
          0,
          Math.min(k.offsetHeight, k.scrollHeight) - a.getStyle(k, 'padding-top') - a.getStyle(k, 'padding-bottom')
        );
      G.getComputedStyle || a.error(27, !0);
      if ((k = G.getComputedStyle(k, void 0)))
        (k = k.getPropertyValue(c)), a.pick(p, 'opacity' !== c) && (k = a.pInt(k));
      return k;
    };
    ...
    a.addEvent = function (k, c, p, t) {
      ...
      v =
        'function' === typeof k && k.prototype
          ? (k.prototype.protoEvents = k.prototype.protoEvents || {})
          : (k.hcEvents = k.hcEvents || {});
    ...
    a.removeEvent = function (k, c, p) {
      ...
      ['protoEvents', 'hcEvents'].forEach(function (a) {
        ...
        e &&
          (c
            ? ((w = e[c] || []),
              p ? ((r = w.indexOf(p)), -1 < r && (w.splice(r, 1), (e[c] = w)), t(c, p)) : (v(e), (e[c] = [])))
            : (v(e), (k[a] = {})));
      });
    };
    a.fireEvent = function (k, c, p, t) {
      var v, w, r, h, e;
      p = p || {};
      F.createEvent && (k.dispatchEvent || k.fireEvent)
        ? ((v = F.createEvent('Events')),
          v.initEvent(c, !0, !0),
          a.extend(v, p),
          k.dispatchEvent ? k.dispatchEvent(v) : k.fireEvent(c, v))
        : ['protoEvents', 'hcEvents'].forEach(function (l) {
            if (k[l])
              for (
                w = k[l][c] || [],
                  r = w.length,
    ...
    a.animate = function (k, c, p) {
      ...
      a.objectEach(c, function (e, h) {
        ...
        w = null;
        'd' === h
          ? ((r.paths = r.initPath(k, k.d, c.d)), (r.toD = c.d), (t = 0), (w = 1))
          : k.attr
          ? (t = k.attr(h))
          : ((t = parseFloat(a.getStyle(k, h)) || 0), 'opacity' !== h && (v = 'px'));
        w || (w = e);
    ...
    G.jQuery &&
      (G.jQuery.fn.highcharts = function () {
        ...
        if (this[0])
          return k[0]
            ? (new a[a.isString(k[0]) ? k.shift() : 'Chart'](this[0], k[0], k[1]), this)
            : y[a.attr(this[0], 'data-highcharts-chart')];
      });
  })(I);
  (function (a) {
    var y = a.isNumber,
      ...
      init: function (k) {
        ...
        if ((this.input = k = this.names[k && k.toLowerCase ? k.toLowerCase() : ''] || k) && k.stops)
          ...
          (k &&
            ...
            7 === c
              ? (p = [(k & 16711680) >> 16, (k & 65280) >> 8, k & 255, 1])
              : 4 === c &&
                (p = [
                  ((k & 3840) >> 4) | ((k & 3840) >> 8),
                  ((k & 240) >> 4) | (k & 240),
      ...
      tweenTo: function (a, c) {
        ...
        t.length && k && k.length
          ? ((a = 1 !== t[3] || 1 !== k[3]),
            (c =
              (a ? 'rgba(' : 'rgb(') +
              Math.round(t[0] + (k[0] - t[0]) * (1 - c)) +
              ',' +
              Math.round(t[1] + (k[1] - t[1]) * (1 - c)) +
              ',' +
              Math.round(t[2] + (k[2] - t[2]) * (1 - c)) +
              (a ? ',' + (t[3] + (k[3] - t[3]) * (1 - c)) : '') +
              ')'))
          : (c = a.input || 'none');
        return c;
  ...
  (function (a) {
    ...
    n(y.prototype, {
      ...
      complexColor: function (f, q, d) {
        ...
        a.fireEvent(this.renderer, 'complexColor', { args: arguments }, function () {
          ...
          e &&
            ...
            (l = f.stops),
            (c = d.radialReference),
            b(n) && (f[e] = n = { x1: n[0], y1: n[1], x2: n[2], y2: n[3], gradientUnits: 'userSpaceOnUse' }),
            'radialGradient' === e &&
              c &&
              !r(n.gradientUnits) &&
              ((h = n), (n = m(n, C.getRadialAttr(c, h), { gradientUnits: 'userSpaceOnUse' }))),
            D(n, function (a, f) {
              'id' !== f && K.push(f, a);
            }),
            D(l, function (a) {
            ...
            J[K]
              ...
              : ((n.id = u = a.uniqueKey()),
                ...
                l.forEach(function (f) {
                  0 === f[1].indexOf('rgba')
                    ? ((g = a.color(f[1])), (P = g.get('rgb')), (x = g.get('a')))
                    : ((P = f[1]), (x = 1));
      ...
      attr: function (f, q, d, b) {
        ...
        'string' === typeof f
          ? (m = (this[f + 'Getter'] || this._defaultGetter).call(this, f, g))
          : (D(
              f,
              function (C, q) {
                n = !1;
                ...
                n ||
                  ((h = this[q + 'Setter'] || this._defaultSetter),
                  h.call(this, C, q, g),
                  !this.styledMode &&
                    this.shadows &&
                    /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(q) &&
                    this.updateShadows(q, C, h));
              },
              this
            ),
            this.afterSetters());
        ...
        m &&
          ...
          a &&
            (null === a.width || 'auto' === a.width
              ...
              : 'text' === d.nodeName.toLowerCase() && a.width && (b = this.textWidth = f(a.width))),
          (this.styles = a),
      ...
      strokeWidth: function () {
        ...
        a.indexOf('px') === a.length - 2
          ? (a = f(a))
          : ((q = l.createElementNS(J, 'rect')),
            c(q, { width: a, 'stroke-width': 0 }),
          ...
          : g &&
            a.push(
              'rotate(' +
                g +
                ' ' +
                A(this.rotationOriginX, m.getAttribute('x'), 0) +
                ' ' +
                A(this.rotationOriginY, m.getAttribute('y') || 0) +
                ')'
            );
      ...
      align: function (a, f, q) {
        ...
        var n, h;
        if (a) {
          if (((this.alignOptions = a), (this.alignByTranslate = f), !q || E(q)))
            (this.alignTo = C = q || 'renderer'), d(g, this), g.push(this), (q = null);
      ...
      getBBox: function (a, f) {
        ...
        if (!q) {
          if (x || C.forExport) {
            try {
              (J =
                ...
                (q = b.getBBox ? n({}, b.getBBox()) : { width: b.offsetWidth, height: b.offsetHeight }),
                J && J('');
            } catch (Y) {}
          ...
          C.isSVG &&
            ((a = q.width),
            (C = q.height),
            x && (q.height = C = { '11px,17': 14, '13px,20': 16 }[g && g.fontSize + ',' + Math.round(C)] || C),
            f &&
              ((q.width = Math.abs(C * Math.sin(d)) + Math.abs(a * Math.cos(d))),
        ...
        if (!a) this.destroyShadows();
          ...
          for (C = 1; C <= m; C++)
            (b = g.cloneNode(0)),
              ...
              q && (c(b, 'height', Math.max(c(b, 'height') - e, 0)), (b.cutHeight = e)),
      ...
      zIndexSetter: function (a, q) {
        ...
        var h;
        r(a)
          ? (m.setAttribute('data-z-index', a), (a = +a), this[q] === a && (e = !1))
          : r(this[q]) && m.removeAttribute('data-z-index');
        this[q] = a;
        if (e) {
    ...
    y.prototype.translateXSetter = y.prototype.translateYSetter = y.prototype.rotationSetter = y.prototype.verticalAlignSetter = y.prototype.rotationOriginXSetter = y.prototype.rotationOriginYSetter = y.prototype.scaleXSetter = y.prototype.scaleYSetter = y.prototype.matrixSetter = function (
      a,
      f
    ) {
      this[f] = a;
    ...
    y.prototype['stroke-widthSetter'] = y.prototype.strokeSetter = function (a, f, q) {
      ...
      this.stroke && this['stroke-width']
        ? (y.prototype.fillSetter.call(this, this.stroke, 'stroke', q),
          q.setAttribute('stroke-width', this['stroke-width']),
          (this.hasStroke = !0))
        : 'stroke-width' === f && 0 === a && this.hasStroke && (q.removeAttribute('stroke'), (this.hasStroke = !1));
    };
    ...
    n(F.prototype, {
      ...
      init: function (a, f, q, b, d, g, e) {
        ...
        this.alignedObjects = [];
        this.url =
          (x || B) && l.getElementsByTagName('base').length
            ? R.location.href
                .split('#')[0]
                .replace(/<[^>]*>/g, '')
                .replace(/([\('\)])/g, '\\$1')
      ...
      buildText: function (a) {
        var q = a.element,
          ...
          H = function (a) {
            var g;
            b.styledMode ||
              (g = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : L || b.style.fontSize || 12);
          ...
          w = function (a, f) {
            ...
            q = a.indexOf(f + '\x3d');
            if (-1 !== q && ((q = q + f.length + 1), (f = a.charAt(q)), '"' === f || "'" === f))
              return (a = a.substring(q + 1)), a.substring(0, a.indexOf(f));
          };
        ...
        if (B !== a.textCache) {
          ...
          e || x || u || z || -1 !== g.indexOf(' ')
            ? (C && C.appendChild(q),
              ...
              g.forEach(function (f, g) {
                ...
                e.forEach(function (f) {
                  if ('' !== f || 1 === e.length) {
                    ...
                    (A = w(f, 'href')) &&
                      !d &&
                      (c(x, 'onclick', 'location.href\x3d"' + A + '"'),
                      c(x, 'class', 'highcharts-anchor'),
                      b.styledMode || v(x, { cursor: 'pointer' }));
              ...
              C && C.removeChild(q),
              x && a.applyTextOutline && a.applyTextOutline(x))
            : q.appendChild(l.createTextNode(E(g)));
        }
      },
      ...
      button: function (a, f, q, b, g, d, e, h, z) {
        ...
        C.setState = function (a) {
          1 !== a && (C.state = J = a);
          C.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass(
      ...
      arc: function (a, f, q, b, g, d) {
        H(a) ? ((b = a), (f = b.y), (q = b.r), (a = b.x)) : (b = { innerR: b, start: g, end: d });
        ...
        var e = { preserveAspectRatio: 'none' },
          ...
          h = function (a, f) {
            a.setAttributeNS
              ...
              : a.setAttribute('hc-svg-href', f);
          },
          J = function (f) {
            h(m.element, a);
            d.call(m, f);
          };
        1 < arguments.length && n(e, { x: f, y: q, width: b, height: g });
        m = this.createElement('image').attr(e);
        d
          ? (h(m.element, 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d'),
            (e = new R.Image()),
            G(e, 'load', J),
            (e.src = a),
            e.complete && J({}))
      ...
      symbol: function (a, f, q, b, g, d) {
        ...
        x
          ? ((m = this.path(c)),
            ...
            n(m, { symbolName: z, x: f, y: q, width: b, height: g }),
            d && n(m, d))
          : J &&
            ((C = a.match(h)[1]),
            (m = this.image(C)),
            ...
            ['width', 'height'].forEach(function (a) {
              m[a + 'Setter'] = function (a, f) {
                ...
                r(b) &&
                  ...
                  this.alignByTranslate || ((q[g] = ((this[f] || 0) - b) / 2), this.attr(q)));
              };
            }),
            r(f) && m.attr({ x: f, y: q }),
            (m.isImg = !0),
            r(m.imgwidth) && r(m.imgheight)
              ? u()
      ...
      symbols: {
        circle: function (a, f, q, b) {
          return this.arc(a + q / 2, f + b / 2, q / 2, b / 2, { start: 0, end: 2 * Math.PI, open: !1 });
        },
        ...
        arc: function (a, f, q, b, g) {
          var d = g.start,
            ...
            n = g.end - 0.001;
          q = g.innerR;
          b = A(g.open, 0.001 > Math.abs(g.end - g.start - 2 * Math.PI));
          var h = Math.cos(d),
            J = Math.sin(d),
            z = Math.cos(n),
            n = Math.sin(n);
          g = 0.001 > g.end - d - Math.PI ? 0 : 1;
        ...
        callout: function (a, f, q, b, g) {
          ...
          m && m > q
            ? g > f + e && g < f + b - e
              ? n.splice(13, 3, 'L', a + q, g - 6, a + q + 6, g, a + q, g + 6, a + q, f + b - d)
              : n.splice(13, 3, 'L', a + q, b / 2, m, g, a + q, b / 2, a + q, f + b - d)
            : m && 0 > m
            ? g > f + e && g < f + b - e
              ? n.splice(33, 3, 'L', a, g + 6, a - 6, g, a, g - 6, a, f + d)
              : n.splice(33, 3, 'L', a, b / 2, m, g, a, b / 2, a, f + d)
            : g && g > b && m > a + e && m < a + q - e
            ? n.splice(23, 3, 'L', m + 6, f + b, m, f + b + 6, m - 6, f + b, a + d, f + b)
            : g && 0 > g && m > a + e && m < a + q - e && n.splice(3, 3, 'L', m - 6, f, m, f - 6, m + 6, f, q - d, f);
          return n;
        },
      },
      ...
      fontMetrics: function (a, q) {
        a =
          (!this.styledMode && /px/.test(a)) || !R.getComputedStyle
            ? a || (q && q.style && q.style.fontSize) || (this.style && this.style.fontSize)
            : q && y.prototype.getStyle.call(q, 'font-size');
        a = /px/.test(a) ? f(a) : 12;
        q = 24 > a ? a + 3 : Math.round(1.2 * a);
        return { h: q, b: Math.round(0.8 * q), f: a };
      },
      ...
      label: function (f, b, g, d, e, h, J, z, x) {
        var l = this,
          ...
          D = (u.text = l.text('', 0, 0, J).attr({ zIndex: 1 })),
          K,
          L,
          C = 0,
          A = 3,
        ...
        U = function () {
          ...
          v &&
            (K ||
              ((u.box = K = l.symbols[d] || R ? l.symbol(d) : l.rect()),
        ...
        O = function () {
          var a = B + A,
            f;
          f = z ? 0 : t;
          r(M) && L && ('center' === T || 'right' === T) && (a += { center: 0.5, right: 1 }[T] * (M - L.width));
          if (a !== D.x || f !== D.y)
            D.attr('x', a), D.hasBoxWidthChanged && ((L = D.getBBox(!0)), U()), void 0 !== f && D.attr('y', f);
          D.x = a;
          D.y = f;
        };
        S = function (a, f) {
    ...
    c(h.prototype, {
      ...
      htmlUpdateTransform: function () {
        if (this.added) {
          ...
          this.inverted &&
            [].forEach.call(d.childNodes, function (f) {
              a.invertChild(f, d);
            });
          if ('SPAN' === d.tagName) {
            var B = this.rotation,
              ...
              A;
            (A = z !== this.oldTextWidth) &&
              !(A = z > this.oldTextWidth) &&
              ((A = this.textPxLength) || (G(d, { width: '', whiteSpace: m || 'nowrap' }), (A = d.offsetWidth)),
              (A = A > z));
            A && (/[ \-]/.test(d.textContent || d.innerText) || 'ellipsis' === d.style.textOverflow)
              ? (G(d, { width: z + 'px', display: 'block', whiteSpace: m || 'normal' }),
                (this.oldTextWidth = z),
                (this.hasBoxWidthChanged = !0))
              : (this.hasBoxWidthChanged = !1);
            D !== this.cTT &&
              ((m = a.fontMetrics(d.style.fontSize, d).b),
  ...
  (function (a) {
    ...
    a.Time.prototype = {
      ...
      update: function (a) {
        ...
        (this.variableTimezone = !(c && !a.getTimezoneOffset && !a.timezone)) || this.timezoneOffset
      ...
      makeTime: function (c, p, w, r, h, e) {
        ...
        this.useUTC
          ? ((l = this.Date.UTC.apply(0, arguments)),
            ...
            n !== d ? (l += d - n) : n - 36e5 !== this.getTimezoneOffset(l - 36e5) || a.isSafari || (l -= 36e5))
          : (l = new this.Date(c, p, k(w, 1), k(r, 0), k(h, 0), k(e, 0)).getTime());
        return l;
      },
      ...
      getTimeTicks: function (a, p, w, r) {
        ...
        if (y(p)) {
          ...
          g >= c.month &&
            (h.set('Month', l, g >= c.year ? 0 : b * Math.floor(h.get('Month', l) / b)), (d = h.get('FullYear', l)));
            ...
            e.push(p),
              (p =
                g === c.year
                  ...
                  : !x || (g !== c.day && g !== c.week)
                  ? x && g === c.hour && 1 < b
                    ? h.makeTime(d, r, u, H + l * b)
                    : p + g * b
                  : h.makeTime(d, r, u + l * b * (g === c.day ? 1 : 7))),
              l++;
          e.push(p);
          g <= c.hour &&
            1e4 > e.length &&
        ...
        e.info = F(a, { higherRanks: n, totalRange: g * b });
        return e;
      },
    };
  })(I);
  ...
  (function (a) {
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        r.isDatetimeAxis &&
          b &&
          ((B = e.time.resolveDTLFormat(h.dateTimeLabelFormats[(!h.grid && b.higherRanks[d]) || b.unitName])),
          (E = B.main));
        c.isFirst = x;
        c.isLast = u;
        c.formatCtx = {
        ...
        if ((z = B && B.list))
          c.shortenLabel = function () {
            for (m = 0; m < z.length; m++)
              if (
                (k.attr({ text: r.labelFormatter.call(a.extend(c.formatCtx, { dateTimeLabelFormat: z[m] })) }),
        ...
        if (F(k))
          k &&
            k.textStr !== h &&
            (!k.textWidth || (g.style && g.style.width) || k.styles.width || k.css({ width: null }),
            k.attr({ text: h }));
        else {
          if ((c.label = k = F(h) && g.enabled ? e.renderer.text(h, 0, 0, g.useHTML).add(r.labelGroup) : null))
            e.styledMode || k.css(p(g.style)), (k.textPxLength = k.getBBox().width);
          c.rotation = 0;
        }
      },
      ...
      handleOverflow: function (a) {
        var c = this.axis,
          ...
          g = this.label,
          b = this.rotation,
          x = { left: 0, center: 0.5, right: 1 }[c.labelAlign || g.attr('align')],
          u = g.getBBox().width,
        ...
        if (b || 'justify' !== t(h.overflow, 'justify'))
          0 > b && e - x * u < d
            ? (m = Math.round(e / Math.cos(b * v) - d))
            : 0 < b && e + x * u > n && (m = Math.round((l - e) / Math.cos(b * v)));
        else if (
          ((l = e + (1 - x) * u),
          e - x * u < d ? (E = a.x + E * (1 - x) - d) : l > n && ((E = n - a.x + E * x), (B = -1)),
          (E = Math.min(k, E)),
        ...
        m &&
          (this.shortenLabel
            ? this.shortenLabel()
            : ((z.width = Math.floor(m)), (h.style || {}).textOverflow || (z.textOverflow = 'ellipsis'), g.css(z)));
      },
      getPosition: function (c, r, h, e) {
        ...
        c = {
          x: c
            ? a.correctFloat(l.translate(r + h, null, null, e) + l.transB)
            : l.left + l.offset + (l.opposite ? ((e && n.oldChartWidth) || n.chartWidth) - l.right - l.left : 0),
          y: c
            ? d - l.bottom + l.offset - (l.opposite ? l.height : 0)
            : a.correctFloat(d - l.translate(r + h, null, null, e) - l.transB),
        };
      ...
      getLabelPosition: function (a, c, h, e, l, n, d, g) {
        var b = this.axis,
          ...
          u = b.reversed,
          r = b.staggerLines,
          E = b.tickRotCorr || { x: 0, y: 0 },
          B = l.y,
          m = e || b.reserveSpaceDefault ? 0 : -b.labelOffset * ('center' === b.labelAlign ? 0.5 : 1),
          z = {};
        F(B) ||
          (B =
            0 === b.side
              ...
              : 2 === b.side
              ? E.y + 8
              : Math.cos(h.rotation * v) * (E.y - h.getBBox(!1, 0).height / 2));
      ...
      renderGridLine: function (a, c, h) {
        var e = this.axis,
          ...
          l = l[r + 'LineDashStyle'];
        n ||
          (e.chart.styledMode || ((d.stroke = B), (d['stroke-width'] = k), l && (d.dashstyle = l)),
          b || (d.zIndex = 1),
          a && (c = 0),
          (this.gridLine = n = u
            .path()
            .attr(d)
            .addClass('highcharts-' + (b ? b + '-' : '') + 'grid-line')
            .add(e.gridGroup)));
        if (n && (h = e.getPlotLinePath(g + x, n.strokeWidth() * h, a, 'pass')))
          n[a || this.isNew ? 'attr' : 'animate']({ d: h, opacity: c });
      },
        ...
        b &&
          ...
          u &&
            ((this.mark = x = n
              ...
              .add(e.axisGroup)),
            e.chart.styledMode || x.attr({ stroke: l, 'stroke-width': k })),
          x[u ? 'attr' : 'animate']({ d: this.getMarkPath(r, a, b[0], x.strokeWidth() * h, e.horiz, n), opacity: c }));
      },
      renderLabel: function (a, r, h, e) {
        ...
        g &&
          c(k) &&
          ((g.xy = a = this.getLabelPosition(k, a, g, n, b, l, e, x)),
          (this.isFirst && !this.isLast && !t(d.showFirstLabel, 1)) ||
          (this.isLast && !this.isFirst && !t(d.showLastLabel, 1))
            ? (u = !1)
            : !n || b.step || b.rotation || r || 0 === h || this.handleOverflow(a),
          x && e % x && (u = !1),
          u && c(a.y)
            ? ((a.opacity = h), g[this.isNewLabel ? 'attr' : 'animate'](a), (this.isNewLabel = !1))
            : (g.attr('y', -9999), (this.isNewLabel = !0)));
      },
  ...
  var X = (function (a) {
    ...
    a.extend(A.prototype, {
              ...
              if (a.isXAxis)
                (b = f.xData),
                  b.length &&
                    ((f = k(b)),
                    (e = G(b)),
                    g(f) || f instanceof Date || ((b = b.filter(g)), (f = k(b)), (e = G(b))),
                    b.length &&
                      ((a.dataMin = Math.min(E(a.dataMin, b[0], f), f)),
                ...
                v(f) &&
                  v(e) &&
                  ((a.dataMin = Math.min(E(a.dataMin, f), f)), (a.dataMax = Math.max(E(a.dataMax, e), e))),
                v(d) && (a.threshold = d),
      ...
      translate: function (a, q, b, d, e, m) {
        ...
        q
          ? ((a = (a * h + n - u) / c + d), e && (a = f.lin2val(a)))
          : (e && (a = f.val2lin(a)), (a = g(d) ? h * (a - d) * c + n + h * u + (g(m) ? c * m : 0) : void 0));
        return a;
      },
      ...
      getPlotLinePath: function (a, q, b, d, m) {
        ...
        e(this, 'getPlotLinePath', A, function (e) {
          ...
          g(m)
            ? f.horiz
              ? ((l = c), (x = D - f.bottom), (u = z = B(u, n, n + f.width)))
              : ((u = n), (z = r - f.right), (l = x = B(l, c, c + f.height)))
            : ((k = !0), (d = !1));
      ...
      getMinorTickPositions: function () {
        ...
        if (h && h / g < a.len / 3)
          ...
          else for (q = m + ((b[0] - m) % g); q <= e && q !== d[0]; q += g) d.push(q);
      ...
      adjustForMinRange: function () {
        ...
        b - q < this.minRange &&
          ...
          (b = k(b)),
          b - q < u && ((g[0] = b - u), (g[1] = E(a.min, b - u)), (q = G(g))));
        this.min = q;
        this.max = b;
      },
      getClosest: function () {
      ...
      nameToX: function (a) {
        ...
        v(g) ||
          (g =
            !1 === this.options.uniqueNames ? a.series.autoIncrement() : f ? b.indexOf(a.name) : E(b.keys[a.name], -1));
      ...
      updateNames: function () {
        var a = this,
          q = this.names;
        0 < q.length &&
          (Object.keys(q.keys).forEach(function (a) {
            delete q.keys[a];
          }),
          (q.length = 0),
          ...
          (this.series || []).forEach(function (f) {
            ...
            f.data.forEach(function (q, b) {
              ...
              q &&
                q.options &&
                void 0 !== q.name &&
                ((g = a.nameToX(q)), void 0 !== g && g !== q.x && ((q.x = g), (f.xData[b] = g)));
            });
          }));
      },
      ...
      setTickInterval: function (f) {
        ...
        G = E(b.userMax, m.max);
        z
          ? ((b.linkedParent = d[b.coll][m.linkedTo]),
            (r = b.linkedParent.getExtremes()),
            (b.min = E(r.min, r.dataMin)),
            (b.max = E(r.max, r.dataMax)),
            m.type !== b.linkedParent.options.type && a.error(11, 1, d))
          : (!w && v(H) && (b.dataMin >= H ? ((r = H), (D = 0)) : b.dataMax <= H && ((t = H), (x = 0))),
            (b.min = E(y, r, b.dataMin)),
            (b.max = E(G, t, b.dataMax)));
        h &&
          (b.positiveValuesOnly && !f && 0 >= Math.min(b.min, E(b.dataMin, b.min)) && a.error(10, 1, d),
          (b.min = p(b.log2lin(b.min), 15)),
          (b.max = p(b.log2lin(b.max), 15)));
        b.range &&
          v(b.max) &&
          ((b.userMin = b.min = y = Math.max(b.dataMin, b.minFromRange())), (b.userMax = G = b.max), (b.range = null));
        e(b, 'foundExtremes');
        b.beforePadding && b.beforePadding();
        b.adjustForMinRange();
        !(B || b.axisPointRange || b.usePercentage || z) &&
          v(b.min) &&
          v(b.max) &&
          (d = b.max - b.min) &&
          (!v(y) && D && (b.min -= d * D), !v(G) && x && (b.max += d * x));
        ...
        b.tickInterval =
          b.min === b.max || void 0 === b.min || void 0 === b.max
            ? 1
            : z && !k && A === b.linkedParent.options.tickPixelInterval
            ? (k = b.linkedParent.tickInterval)
            : E(
                k,
                this.tickAmount ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1) : void 0,
                B ? 1 : ((b.max - b.min) * A) / Math.max(b.len, A)
              );
        l &&
          !f &&
        ...
        c ||
          ...
          (b.tickInterval = u(
            ...
            null,
            n(b.tickInterval),
            E(m.allowDecimals, !(0.5 < b.tickInterval && 5 > b.tickInterval && 1e3 < b.max && 9999 > b.max)),
            !!this.tickAmount
          ));
      ...
      setTickPositions: function () {
        ...
        var d = f.tickPositioner,
          m = f.startOnTick,
          h = f.endOnTick;
        this.tickmarkOffset = this.categories && 'between' === f.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0;
        this.minorTickInterval = 'auto' === b && this.tickInterval ? this.tickInterval / 5 : b;
        this.single =
          this.min === this.max &&
          v(this.min) &&
          !this.tickAmount &&
          (parseInt(this.min, 10) === this.min || !1 !== f.allowDecimals);
        this.tickPositions = b = g && g.slice();
        !b &&
          (!this.ordinalPositions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)
            ? ((b = [this.min, this.max]), a.error(19, !1, this.chart))
            : (b = this.isDatetimeAxis
                ? this.getTimeTicks(
                    this.normalizeTimeTickInterval(this.tickInterval, f.units),
                    this.min,
                    this.max,
                    f.startOfWeek,
        ...
        this.isLinked ||
          (this.single && 2 > b.length && ((this.min -= 0.5), (this.max += 0.5)), g || d || this.adjustTickAmount());
      ...
      trimTicks: function (a, b, g) {
        ...
        if (!this.isLinked) {
          ...
          else for (; this.min - q > a[0]; ) a.shift();
          if (g) this.max = d;
          else for (; this.max + q < a[a.length - 1]; ) a.pop();
        ...
        e(this, 'zoom', a, function (a) {
          ...
          if (b !== this.min || d !== this.max)
            this.allowZoomOutside ||
              (v(f) && (b < q && (b = q), b > m && (b = m)), v(g) && (d < q && (d = q), d > m && (d = m))),
              (this.displayBtn = void 0 !== b || void 0 !== d),
              this.setExtremes(b, d, !1, void 0, { trigger: 'zoom' });
          a.zoomed = !0;
        });
        return a.zoomed;
      },
      ...
      unsquish: function () {
        ...
        b
          ? (z = !a.staggerLines && !a.step && (v(h) ? [h] : e < E(a.autoRotationLimit, 80) && a.autoRotation)) &&
      ...
      getSlotWidth: function (a) {
        ...
        return (
          (a && a.slotWidth) ||
          (b && 2 > (g.step || 0) && !g.rotation && ((this.staggerLines || 1) * this.len) / d) ||
          (!b && ((g.style && parseInt(g.style.width, 10)) || (e && e - f.spacing[3]) || 0.33 * f.chartWidth))
        );
      },
      renderUnsquish: function () {
        ...
        if (this.autoRotation) k > u && k > l.h ? (z.rotation = this.labelRotation) : (this.labelRotation = 0);
          ...
          for (r = 'clip', u = d.length; !n && u--; )
            if (((A = d[u]), (A = e[A].label)))
              A.styles && 'ellipsis' === A.styles.textOverflow
                ? A.css({ textOverflow: 'clip' })
                : A.textPxLength > c && A.css({ width: c + 'px' }),
                A.getBBox().height > this.len / d.length - (l.h - l.f) && (A.specificTextOverflow = 'ellipsis');
        z.rotation && ((D = k > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : k), x || (r = 'ellipsis'));
        ...
        d.forEach(function (a) {
          ...
          f &&
            ...
            a.shortenLabel
              ? a.shortenLabel()
              : D && !b && 'nowrap' !== h.whiteSpace && (D < f.textPxLength || 'SPAN' === f.element.tagName)
              ? ((g.width = D), x || (g.textOverflow = f.specificTextOverflow || r), f.css(g))
              : f.styles && f.styles.width && !g.width && !b && f.css({ width: null }),
        ...
        this.axisTitle ||
          ((e = d.textAlign) ||
            (e = (b
              ...
              : { low: g ? 'right' : 'left', middle: 'center', high: g ? 'left' : 'right' })[d.align]),
          (this.axisTitle = f
      ...
      getOffset: function () {
        ...
        a.axisGroup ||
          ((a.gridGroup = g
            ...
            .addClass('highcharts-' + this.coll.toLowerCase() + '-grid ' + (t || ''))
            .add(y)),
          (a.axisGroup = g
            .g('axis')
        ...
        z || a.isLinked
          ? (m.forEach(function (b, f) {
            ...
            a.renderUnsquish(),
            (a.reserveSpaceDefault = 0 === c || 2 === c || { 1: 'left', 3: 'right' }[c] === a.labelAlign),
            E(A.reserveSpace, 'center' === a.labelAlign ? !0 : null, a.reserveSpaceDefault) &&
              m.forEach(function (a) {
                B = Math.max(h[a].getLabelSize(), B);
              }),
            a.staggerLines && (B *= a.staggerLines),
            (a.labelOffset = B * (a.opposite ? -1 : 1)))
          : H(h, function (a, b) {
              a.destroy();
              delete h[b];
            });
        k &&
          ...
          l &&
            !1 !== k.reserveSpace &&
            ((a.titleOffset = x = a.axisTitle.getBBox()[n ? 'height' : 'width']),
            (D = k.offset),
      ...
      getTitlePosition: function () {
        var a = this.horiz,
          ...
          b =
            (a ? g + this.height : b) +
            (a ? 1 : -1) * (n ? -1 : 1) * this.axisTitleMargin +
            [-l, l, x.f, -l][this.side],
          a = { x: a ? d + u : b + (n ? this.width : 0) + c + u, y: a ? b + z - (n ? this.height : 0) + c : d + z };
      ...
      renderTick: function (a, b) {
        ...
        if (!f || (a >= this.min && a <= this.max))
          d[a] || (d[a] = new D(this, a)), e && d[a].isNew && d[a].render(b, !0, -1), d[a].render(b);
      },
      render: function () {
        var b = this,
          d = b.chart,
        ...
        if (b.hasData() || n)
          b.minorTickInterval &&
            ...
            c.length &&
              ...
              B && (0 === b.min || b.single) && (l[-1] || (l[-1] = new D(b, -1, null, !0)), l[-1].render(-1))),
            A &&
              c.forEach(function (f, g) {
                ...
                0 === g % 2 &&
                  f < b.max &&
                  v <= b.max + (d.polar ? -B : B) &&
                  (r[f] || (r[f] = new a.PlotLineOrBand(b)),
                  (t = f + B),
                  (r[f].options = { from: h ? b.lin2log(t) : t, to: h ? b.lin2log(v) : v, color: A }),
                  r[f].render(),
                  (r[f].isActive = !0));
              }),
            b._addedPlotLB ||
              ((m.plotLines || []).concat(m.plotBands || []).forEach(function (a) {
        ...
        E &&
          (E[E.isPlaced ? 'animate' : 'attr']({ d: this.getLinePath(E.strokeWidth()) }),
          (E.isPlaced = !0),
          E[p ? 'show' : 'hide'](!0));
        u &&
          p &&
          ((m = b.getTitlePosition()),
          g(m.y) ? (u[u.isNew ? 'attr' : 'animate'](m), (u.isNew = !1)) : (u.attr('y', -9999), (u.isNew = !0)));
      ...
      drawCrosshair: function (a, b) {
        ...
        if (this.crosshair && !1 !== (v(b) || !d)) {
          d
            ? v(b) && (m = E(b.crosshairPos, this.isXAxis ? b.plotX : this.len - b.plotY))
            : (m = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos));
          ...
          h ||
            ((this.cross = h = this.chart.renderer
              .path()
              .addClass('highcharts-crosshair highcharts-crosshair-' + (d ? 'category ' : 'thin ') + g.className)
              .attr({ zIndex: E(g.zIndex, 2) })
              .add()),
            this.chart.styledMode ||
              (h
                .attr({
                  stroke: g.color || (d ? c('#ccd6eb').setOpacity(0.25).get() : '#cccccc'),
                  'stroke-width': E(g.width, 1),
                })
                .css({ 'pointer-events': 'none' }),
              g.dashStyle && h.attr({ dashstyle: g.dashStyle })));
          h.show().attr({ d: f });
  ...
  (function (a) {
    ...
    y.prototype.normalizeTimeTickInterval = function (a, p) {
      ...
      for (
        r = 0;
        r < c.length &&
        !((p = c[r]), (v = k[p[0]]), (w = p[1]), c[r + 1] && a <= (v * w[w.length - 1] + k[c[r + 1][0]]) / 2);
        r++
      );
  ...
  (function (a) {
    ...
    y.prototype.getLogTickPositions = function (a, p, t, v) {
      ...
      if (0.5 <= a) (a = Math.round(a)), (h = this.getLinearTickPositions(a, p, t));
      else if (0.08 <= a)
        for (
          var r = Math.floor(p),
            e,
            ...
            d,
            g,
            c = 0.3 < a ? [1, 2, 4] : 0.15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9];
          r < t + 1 && !g;
          r++
        )
        ...
        (p = this.lin2log(p)),
          ...
          (a = k(
            ...
            ((c.tickPixelInterval / (v ? 5 : 1)) * (t - p)) / ((v ? r / this.tickPositions.length : r) || 1)
          )),
          (a = G(a, null, F(a))),
  ...
  (function (a, y) {
    ...
    a.PlotLineOrBand.prototype = {
      render: function () {
        ...
        var c = this,
          ...
          z = v(e.zIndex, 0),
          D = e.events,
          B = { class: 'highcharts-plot-' + (x ? 'band ' : 'line ') + (e.className || '') },
          A = {},
          f = r.chart.renderer,
          q = x ? 'bands' : 'lines';
        ...
        r.chart.styledMode ||
          (u
            ? ((B.stroke = m), (B['stroke-width'] = e.width), e.dashStyle && (B.dashstyle = e.dashStyle))
            : x &&
              (m && (B.fill = m), e.borderWidth && ((B.stroke = e.borderColor), (B['stroke-width'] = e.borderWidth))));
        A.zIndex = z;
        q += '-' + z;
        (m = r.plotLinesAndBandsGroups[q]) ||
          (r.plotLinesAndBandsGroups[q] = m = f
            .g('plot-' + q)
            .attr(A)
            .add());
        ...
        l && k(l.text) && B && B.length && 0 < r.width && 0 < r.height && !B.isFlat
          ? ((l = t(
              {
                align: h && x && 'center',
                x: h ? !x && 4 : 10,
    ...
    a.extend(y.prototype, {
      getPlotBandPath: function (a, c) {
        ...
        if (e && h)
          for (a && ((g = e.toString() === h.toString()), (d = 0)), a = 0; a < e.length; a += 6)
            n && h[a + 1] === e[a + 1]
              ? ((h[a + 1] += d), (h[a + 4] += d))
              : n || h[a + 2] !== e[a + 2] || ((h[a + 2] += d), (h[a + 5] += d)),
      ...
      removePlotBandOrLine: function (a) {
        ...
        [h.plotLines || [], e.plotLines || [], h.plotBands || [], e.plotBands || []].forEach(function (e) {
          for (l = e.length; l--; ) e[l].id === a && p(e, e[l]);
        });
      },
  ...
  (function (a) {
    ...
    a.Tooltip.prototype = {
      ...
      getLabel: function () {
        ...
        this.label ||
          (this.outside &&
            ((this.container = n = a.doc.createElement('div')),
            (n.className = 'highcharts-tooltip-container'),
            a.css(n, { position: 'absolute', top: '1px', pointerEvents: l.style && l.style.pointerEvents }),
            a.doc.body.appendChild(n),
            (this.renderer = h = new a.Renderer(n, 0, 0))),
          this.split
            ? (this.label = h.g('tooltip'))
            : ((this.label = h
                .label('', 0, 0, l.shape || 'callout', null, null, l.useHTML, null, 'tooltip')
                .attr({ padding: l.padding, r: l.borderRadius })),
              e ||
                this.label
                  .attr({ fill: l.backgroundColor, 'stroke-width': l.borderWidth })
                  .css(l.style)
                  .shadow(l.shadow)),
          e && (this.applyFilter(), this.label.addClass('highcharts-tooltip-' + this.chart.index)),
          this.outside &&
            ((d = { x: this.label.xSetter, y: this.label.ySetter }),
      ...
      getAnchor: function (a, c) {
        ...
        this.followPointer && c
          ? (void 0 === c.chartX && (c = h.normalize(c)), (a = [c.chartX - e.plotLeft, c.chartY - d]))
          : a[0].tooltipPos
          ? (a = a[0].tooltipPos)
          : (a.forEach(function (a) {
            ...
            (a = [
              n ? e.plotWidth - x : b,
              this.shared && !n && 1 < a.length && c ? c.chartY - d : n ? e.plotHeight - b : x,
            ]));
      ...
      getPosition: function (a, c, e) {
        var h = this.chart,
          ...
          B = [
            ...
            k,
            c,
            (x ? r.top - n : 0) + e.plotY + h.plotTop,
            x ? 0 : h.plotTop,
            x ? k : h.plotTop + h.plotHeight,
          ],
          m = [
            'x',
            u,
            a,
            (x ? r.left - n : 0) + e.plotX + h.plotLeft,
            x ? 0 : h.plotLeft,
            x ? u : h.plotLeft + h.plotWidth,
          ],
      ...
      refresh: function (c, h) {
        ...
        l.enabled &&
          ...
          (h = g[0]),
          (n = g[1]),
          !b || (d.series && d.series.noSharedTooltip)
            ? (b = d.getLabelConfig())
            : (d.forEach(function (a) {
                a.setState('hover');
                x.push(a.getLabelConfig());
              }),
              (b = { x: d[0].category, y: d[0].y }),
              (b.points = x),
              (d = d[0])),
          (this.len = x.length),
          (b = e.call(b, this)),
          ...
          !1 === b
            ...
            : ((e = this.getLabel()),
              ...
              this.split
                ? this.renderSplit(b, t(c))
                : ((l.style.width && !k) || e.css({ width: this.chart.spacingBox.width }),
                  e.attr({ text: b && b.join ? b.join('') : b }),
                  e
                    .removeClass(/highcharts-color-[\d]+/g)
                    .addClass('highcharts-color-' + p(d.colorIndex, u.colorIndex)),
                  k || e.attr({ stroke: l.borderColor || d.color || u.color || '#666666' }),
                  this.updatePosition({ plotX: h, plotY: n, negative: d.negative, ttBelow: d.ttBelow, h: g[2] || 0 })),
              (this.isHidden = !1)));
      },
      renderSplit: function (c, h) {
        ...
        c.slice(0, h.length + 1).forEach(function (a, m) {
          if (!1 !== a && '' !== a) {
            ...
            D ||
              ((D = { padding: b.padding, r: b.borderRadius }),
              n.styledMode ||
                ((D.fill = b.backgroundColor),
                (D.stroke = b.borderColor || m.color || A.color || '#333333'),
                (D['stroke-width'] = b.borderWidth)),
              (c.tt = D = d
                .label(null, null, null, (m.isHeader ? b.headerShape : b.shape) || 'callout', null, null, b.useHTML)
            ...
            m.isHeader
              ? ((x = a.height),
                n.xAxis[0].opposite && ((u = !0), (r -= x)),
                (A = Math.max(
                  0,
                  Math.min(
                    m.plotX + n.plotLeft - A / 2,
                    n.chartWidth + (n.scrollablePixels ? n.scrollablePixels - n.marginRight : 0) - A
                  )
                )))
              : (A = m.plotX + n.plotLeft - p(b.distance, 16) - A);
            0 > A && (g = !1);
            a = (m.series && m.series.yAxis && m.series.yAxis.pos) + (m.plotY || 0);
            a -= r;
            m.isHeader && (a = u ? -x : n.plotHeight + x);
            l.push({ target: a, rank: m.isHeader ? 1 : 0, size: c.tt.getBBox().height + 1, point: m, x: A, tt: D });
          }
        });
        this.cleanSplit();
        b.positioner &&
      ...
      updatePosition: function (a) {
        ...
        var d;
        this.outside &&
          ((d = (this.options.borderWidth || 0) + 2 * this.distance),
      ...
      getDateFormat: function (a, c, e, l) {
        var h = this.chart.time,
          ...
          g,
          b,
          x = { millisecond: 15, second: 12, minute: 9, hour: 6, day: 3 },
          u = 'millisecond';
        for (b in w) {
      ...
      tooltipFooterHeaderFormatter: function (c, h) {
        ...
        a.fireEvent(this, 'headerFormatter', h, function (a) {
          ...
          b &&
            d &&
            ((c.point && c.point.tooltipDateKeys) || ['key']).forEach(function (a) {
  ...
  (function (a) {
    ...
    a.Pointer.prototype = {
      ...
      getChartCoordinatesFromPoint: function (a, b) {
        ...
        if (d && g)
          return b
            ? { chartX: d.len + d.pos - e, chartY: g.len + g.pos - a.plotY }
      ...
      getHoverData: function (a, b, d, e, c, n) {
        ...
        g &&
          (c && !b.noSharedTooltip
            ? ((z = d.filter(function (a) {
                return (
                  a.visible && !(!c && a.directTouch) && l(a.options.enableMouseTracking, !0) && !a.noSharedTooltip
                );
              })),
              z.forEach(function (a) {
      ...
      runPointActions: function (g, b) {
        var d = this.chart,
          ...
          n = this.getHoverData(
            ...
            n,
            d.series,
            'touchmove' !== g.type && (!!b || (n && n.directTouch && this.isDirectTouch)),
            c,
            g
          ),
          m,
        ...
        if (h && (h !== d.hoverPoint || (e && e.isHidden))) {
          ...
          d.hoverPoint = h;
          e && e.refresh(c ? m : h, g);
        } else b && e && !e.isHidden && ((h = e.getAnchor([{}], g)), e.updatePosition({ plotX: h[0], plotY: h[1] }));
        this.unDocMouseMove ||
          (this.unDocMouseMove = y(d.container.ownerDocument, 'mousemove', function (b) {
      ...
      scaleGroups: function (a, b) {
        ...
        g.series.forEach(function (e) {
          ...
          e.xAxis &&
            ...
            e.group &&
            (e.group.attr(d),
            e.markerGroup && (e.markerGroup.attr(d), e.markerGroup.clip(b ? g.clipRect : null)),
      ...
      drag: function (a) {
        ...
        (q && q.touch) ||
          ...
          10 < this.hasDragged &&
            ((f = b.isInsidePlot(r - m, p - n)),
            b.hasCartesianSeries &&
              (this.zoomX || this.zoomY) &&
              f &&
              !t &&
              !q &&
              ((this.selectionMarker = q = b.renderer
                .rect(m, n, c ? 1 : l, h ? 1 : A, 0)
                .attr({ class: 'highcharts-selection-marker', zIndex: 7 })
                .add()),
              b.styledMode ||
                q.attr({
                  fill: g.selectionMarkerFill || k('#335cad').setOpacity(0.25).get(),
                })),
            q && c && ((d -= r), q.attr({ width: Math.abs(d), x: (0 < d ? 0 : d) + r })),
            q && h && ((d = e - p), q.attr({ height: Math.abs(d), y: (0 < d ? 0 : d) + p })),
        ...
        if (this.selectionMarker) {
          ...
          if (this.hasDragged || g)
            d.axes.forEach(function (f) {
              if (f.zoomEnabled && p(f.min) && (g || b[{ xAxis: 'zoomX', yAxis: 'zoomY' }[f.coll]])) {
                var d = f.horiz,
      ...
      onContainerMouseMove: function (d) {
        var b = this.chart;
        (p(a.hoverChartIndex) && G[a.hoverChartIndex] && G[a.hoverChartIndex].mouseIsDown) ||
          (a.hoverChartIndex = b.index);
        d = this.normalize(d);
        d.preventDefault || (d.returnValue = !1);
        'mousedown' === b.mouseIsDown && this.drag(d);
        (!this.inClass(d.target, 'highcharts-tracker') &&
          !b.isInsidePlot(d.chartX - b.plotLeft, d.chartY - b.plotTop)) ||
          b.openMenu ||
      ...
      onContainerClick: function (a) {
        ...
        b.cancelClick ||
          (d && this.inClass(a.target, 'highcharts-tracker')
            ? (w(d.series, 'click', t(a, { point: d })), b.hoverPoint && d.firePointEvent('click', a))
            : (t(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - g, a.chartY - e) && w(b, 'click', a)));
      },
  ...
  (function (a) {
    ...
    F(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function (a, k, t, v, w, r, h, e) {
        ...
        L ? ((A -= 0.8 * (A - h[n][0])), z || (q -= 0.8 * (q - h[n][1])), t()) : (h[n] = [A, q]);
        B || ((r[n] = p - x), (r[b] = u));
        r = B ? 1 / E : E;
        w[b] = u;
        w[n] = k;
      ...
      pinch: function (a) {
        ...
        'touchstart' === a.type
          ? ([].forEach.call(w, function (a, d) {
            ...
            (c.res = !0))
          : c.followTouchMove && 1 === r
          ? this.runPointActions(c.normalize(a))
          : v.length &&
            (l || (c.selectionMarker = l = F({ destroy: G, touch: !0 }, t.plotBox)),
      ...
      touch: function (c, p) {
        ...
        1 === c.touches.length
          ? ((c = this.normalize(c)),
            (w = t.isInsidePlot(c.chartX - t.plotLeft, c.chartY - t.plotTop)) && !t.openMenu
              ? (p && this.runPointActions(c),
                'touchmove' === c.type &&
                  ((p = this.pinchDown),
                  (v = p[0]
                    ? 4 <= Math.sqrt(Math.pow(p[0].chartX - c.chartX, 2) + Math.pow(p[0].chartY - c.chartY, 2))
                    : !1)),
                k(v, !0) && this.pinch(c))
              : p && this.reset())
  ...
  (function (a) {
    ...
    if (!a.hasTouch && (w.PointerEvent || w.MSPointerEvent)) {
      var h = {},
        ...
        n = function (d, g, b, e) {
          ('touch' !== d.pointerType && d.pointerType !== d.MSPOINTER_TYPE_TOUCH) ||
            !F[a.hoverChartIndex] ||
            (e(d),
            (e = F[a.hoverChartIndex].pointer),
            e[g]({ type: b, target: d.currentTarget, preventDefault: p, touches: l() }));
        };
      c(t.prototype, {
      ...
      r(t.prototype, 'init', function (a, g, b) {
        a.call(this, g, b);
        this.hasZoom && G(g.container, { '-ms-touch-action': 'none', 'touch-action': 'none' });
      });
  ...
  (function (a) {
    ...
    a.Legend.prototype = {
      init: function (a, d) {
        ...
        d.enabled &&
          ...
          this.proximate
            ? (this.unchartrender = y(this.chart, 'render', function () {
        ...
        a &&
          ...
          this.allItems.forEach(function (g) {
            var c = g.checkbox,
              h;
            c &&
              ((h = d + b + c.y + (this.scrollOffset || 0) + 3),
              F(c, {
        ...
        e.text &&
          (this.title ||
            ((this.title = this.chart.renderer
              .label(e.text, d - 3, d - 4, null, null, null, a.useHTML, null, 'legend-title')
              .attr({ zIndex: 1 })),
          ...
          ((a.legendGroup = e
            ...
            .addClass(
              'highcharts-' +
                ...
                a.colorIndex +
                (r ? ' ' + r : '') +
                (D ? ' highcharts-series-' + a.index : '')
            )
            .attr({ zIndex: 1 })
            .add(this.scrollGroup)),
          (a.legendItem = z = e.text('', m ? c + h : -h, this.baseline || 0, q)),
          d.styledMode || z.css(v(a.visible ? n : l)),
          z.attr({ align: m ? 'left' : 'right', zIndex: 2 }).add(a.legendGroup),
          this.baseline ||
            ((this.fontMetrics = e.fontMetrics(d.styledMode ? 12 : n.fontSize, z)),
      ...
      layoutItem: function (a) {
        ...
        b &&
          this.itemX - e + d > k &&
          ((this.itemX = e), (this.itemY += n + this.lastLineHeight + h), (this.lastLineHeight = 0));
        ...
        this.offsetWidth =
          this.widthOption || Math.max((b ? this.itemX - e - (a.checkbox ? 0 : l) : d) + e, this.offsetWidth);
      },
      getAllItems: function () {
        ...
        this.chart.series.forEach(function (d) {
          var e = d && d.options;
          d &&
            w(e.showInLegend, k(e.linkedTo) ? !1 : void 0, !0) &&
            (a = a.concat(d.legendItems || ('point' === e.legendType ? d.data : d)));
        });
      ...
      adjustMargins: function (a, d) {
        ...
        c &&
          [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function (g, n) {
            g.test(c) &&
              !k(a[n]) &&
              (e[t[n]] = Math.max(
                e[t[n]],
      ...
      render: function () {
        ...
        g ||
          ((this.group = g = d.g('legend').attr({ zIndex: 7 }).add()),
          (this.contentGroup = d.g().attr({ zIndex: 1 }).add(g)),
        ...
        k += B;
        r ||
          ((this.box = r = d.rect().addClass('highcharts-legend-box').attr({ r: p.borderRadius }).add(g)),
          (r.isNew = !0));
        e.styledMode ||
          r
            .attr({ stroke: p.borderColor, 'stroke-width': p.borderWidth || 0, fill: p.backgroundColor || 'none' })
            .shadow(p.shadow);
        0 < b &&
          0 < k &&
          (r[r.isNew ? 'attr' : 'animate'](r.crisp.call({}, { x: 0, y: 0, width: b, height: k }, r.strokeWidth())),
          (r.isNew = !1));
        r[l ? 'show' : 'hide']();
        ...
        l &&
          ...
          /(lth|ct|rth)/.test(this.getAlignment()) &&
            ((r = d.y + e.titleOffset), (d = v(d, { y: 0 < e.titleOffset ? (r += e.options.title.margin) : r }))),
          g.align(v(p, { width: b, height: k, verticalAlign: this.proximate ? 'top' : p.verticalAlign }), !0, d));
      ...
      handleOverflow: function (a) {
        var d = this,
          ...
          v = function (a) {
            ...
            d.contentGroup.div &&
              (d.contentGroup.div.style.clip = a ? 'rect(' + n + 'px,9999px,' + (n + a) + 'px,0)' : 'auto');
          };
        'horizontal' !== c.layout || 'middle' === c.verticalAlign || c.floating || (h /= 2);
        l && (h = Math.min(h, l));
        q.length = 0;
        a > h && !1 !== z.enabled
          ? ((this.clipHeight = k = Math.max(h - 20 - this.titleHeight - n, 0)),
            ...
            m || ((m = d.clipRect = b.clipRect(0, n, 9999, 0)), d.contentGroup.clip(m)),
            v(k),
            f ||
              ((this.nav = f = b.g().attr({ zIndex: 1 }).add(this.group)),
              (this.up = b
            ...
            d.scroll(0),
            (a = h))
          : f && (v(), (this.nav = f.destroy()), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0));
        return a;
      },
      scroll: function (a, d) {
        var e = this.pages,
        ...
        a > b && (a = b);
        0 < a &&
          (void 0 !== d && r(d, this.chart),
          this.nav.attr({ translateX: n, translateY: c + this.padding + 7 + this.titleHeight, visibility: 'visible' }),
    ...
    a.LegendSymbolMixin = {
      ...
      drawLineMarker: function (a) {
        ...
        var k = {};
        this.chart.styledMode ||
          ((k = { 'stroke-width': d.lineWidth || 0 }), d.dashStyle && (k.dashstyle = d.dashStyle));
        this.legendLine = l.path(['M', 0, a, 'L', b, a]).addClass('highcharts-graph').attr(k).add(n);
        e &&
          !1 !== e.enabled &&
          b &&
          ((d = Math.min(w(e.radius, h), h)),
          0 === this.symbol.indexOf('url') && ((e = v(e, { width: c, height: c })), (d = 0)),
          (this.legendSymbol = e = l
    ...
    (/Trident\/7\.0/.test(e.navigator && e.navigator.userAgent) || p) &&
      l(a.Legend.prototype, 'positionItem', function (a, d) {
        var e = this,
          b = function () {
    ...
    l(T.prototype, {
        ...
        e.forEach(function (a) {
          a.isDirty &&
            ('point' === a.options.legendType
              ...
              : m && (m.labelFormatter || m.labelFormat) && (h = !0));
      ...
      getSelectedPoints: function () {
        ...
        this.series.forEach(function (b) {
          a = a.concat(
            (b[b.hasGroupedData ? 'points' : 'data'] || []).filter(function (a) {
              return a.selected;
            })
          );
        });
        ...
        [
          ...
          a &&
            ...
            ((d[f] = d.renderer
              ...
              .attr({ align: a.align, class: 'highcharts-' + f, zIndex: a.zIndex || 4 })
              .add()),
      ...
      layOutTitles: function (a) {
        ...
        ['title', 'subtitle'].forEach(function (a) {
          ...
          var c;
          f &&
            (this.styledMode || (c = g.style.fontSize),
            (c = d.fontMetrics(c, f).b),
            f.css({ width: (g.width || e.width + g.widthAdjust) + 'px' }).align(l({ y: a + c }, g), !1, 'spacingBox'),
      ...
      getChartSize: function () {
        ...
        this.chartHeight = Math.max(
          0,
          a.relativeLength(b, this.chartWidth) || (1 < this.containerHeight ? this.containerHeight : 400)
        );
      },
        ...
        if (b)
          for (; f && f.style; )
            f.hcOrigStyle && (a.css(f, f.hcOrigStyle), delete f.hcOrigStyle),
              f.hcOrigDetached && (c.body.removeChild(f), (f.hcOrigDetached = !1)),
              (f = f.parentNode);
        else
          for (; f && f.style; ) {
            c.body.contains(f) || f.parentNode || ((f.hcOrigDetached = !0), c.body.appendChild(f));
            if ('none' === a.getStyle(f, 'display', !1) || f.hcOricDetached)
              (f.hcOrigStyle = { display: f.style.display, height: f.style.height, overflow: f.style.overflow }),
      ...
      getContainer: function () {
        ...
        this.renderer = new (a[e.renderer] || a.Renderer)(
          b,
          m,
          q,
          null,
          e.forExport,
          f.exporting && f.exporting.allowHTML,
          this.styledMode
        );
        this.setClassName(e.className);
        if (this.styledMode) for (u in f.defs) this.renderer.definition(f.defs[u]);
      ...
      setReflow: function (a) {
        ...
        !1 === a || this.unbindReflow
          ...
          : ((this.unbindReflow = y(K, 'resize', function (a) {
              b.reflow(a);
            })),
      ...
      setSize: function (b, f, e) {
        ...
        g.styledMode ||
          ((m = c.globalAnimation),
          (m ? F : h)(g.container, { width: g.chartWidth + 'px', height: g.chartHeight + 'px' }, m));
        g.setChartSize(!0);
      ...
      drawChartBox: function () {
        ...
        c[v](p);
        q ||
          (c.attr({ fill: z || 'none' }).shadow(a.plotShadow),
        ...
        v = 'animate';
        m ||
          ((v = 'attr'), (this.plotBorder = m = b.rect().addClass('highcharts-plot-border').attr({ zIndex: 1 }).add()));
      ...
      propFromSeries: function () {
        ...
        ['inverted', 'angular', 'polar'].forEach(function (m) {
          ...
          for (g = e && e.length; !c && g--; ) (d = f[e[g].type]) && d.prototype[m] && (c = !0);
          a[m] = c;
        });
      },
      linkSeries: function () {
  ...
  (function (a) {
    ...
    y(F, 'afterSetChartSize', function (y) {
      ...
      (k = k && k.minWidth) &&
        ...
        (this.scrollablePixels = k = Math.max(0, k - this.chartWidth)) &&
        ((this.plotWidth += k),
  ...
  (function (a) {
    ...
    a.Point.prototype = {
      ...
      optionsToObject: function (e) {
        ...
        if (t(e) || null === e) c[g[0]] = e;
          ...
          for (
            !d &&
            e.length > b &&
            ((h = typeof e[0]), 'string' === h ? (c.name = e[0]) : 'number' === h && (c.x = e[0]), k++);
            u < b;

          )
            (d && void 0 === e[k]) ||
              (0 < g[u].indexOf('.') ? a.Point.prototype.setNestedProperty(c, e[k], g[u]) : (c[g[u]] = e[k])),
              k++,
              u++;
        else
          'object' === typeof e &&
            ((c = e), e.dataLabels && (h._hasPointLabels = !0), e.marker && (h._hasPointMarkers = !0));
        return c;
      },
      ...
      tooltipFormatter: function (a) {
        ...
        return c(a, { point: this, series: this.series }, e.chart.time);
      },
      ...
      },
      {
        ...
        autoIncrement: function () {
          ...
          g &&
            ((a = new f.Date(d)),
            'day' === g
              ? f.set('Date', a, f.get('Date', a) + e)
              : 'month' === g
              ? f.set('Month', a, f.get('Month', a) + e)
              : 'year' === g && f.set('FullYear', a, f.get('FullYear', a) + e),
            (e = a.getTime() - d));
          this.xIncrement = d + e;
          return d;
        },
        setOptions: function (a) {
          ...
          this.tooltipOptions = d(
            p.tooltip,
            p.plotOptions.series && p.plotOptions.series.tooltip,
            p.plotOptions[this.type].tooltip,
          ...
          this.stickyTracking = b(
            ...
            this.tooltipOptions.shared && !this.noSharedTooltip ? !0 : e.stickyTracking
          );
          ...
          (!e.negativeColor && !e.negativeFillColor) ||
            ...
            g.push(c));
          g.length && v(g[g.length - 1].value) && g.push(a ? {} : { color: this.color, fillColor: this.fillColor });
        ...
        getCyclic: function (a, d, e) {
          ...
          d ||
            ((g = b(c[h], c['_' + h])),
            v(g) || (f.series.length || (f[m] = 0), (c['_' + h] = g = f[m] % l), (f[m] += 1)),
            e && (d = e[g]));
          void 0 !== g && (this[h] = g);
          this[a] = d;
        },
        getColor: function () {
          this.chart.styledMode
            ...
            : this.getCyclic('color', this.options.color || t[this.type].color, this.chart.options.colors);
        },
        getSymbol: function () {
          ...
          b.forEach(function (b) {
            ...
            if ((c = c.id) || l(k))
              c && (q = (q = this.chart.get(c)) && q.index),
                ...
                -1 === q || void 0 === q || (e[q] && e[q].touched)
                  ? g.push(b)
                  : b !== d.data[q]
                  ? (e[q].update(b, !1, null, !1), (e[q].touched = !0), m && (h = q + 1))
                  : e[q] && (e[q].touched = !0),
                (f = !0);
          }, this);
          if (f) for (b = e.length; b--; ) (c = e[b]), c.touched || c.remove(!1), (c.touched = !1);
          ...
          if (!H) {
            ...
            if (A && z > A) {
              ...
              if (l(D)) for (c = 0; c < z; c++) (p[c] = this.autoIncrement()), (B[c] = d[c]);
                ...
                if (t) for (c = 0; c < z; c++) (D = d[c]), (p[c] = D[0]), (B[c] = D.slice(1, t + 1));
                else
                  for (
                    v && ((E = v.indexOf('x')), (w = v.indexOf('y')), (E = 0 <= E ? E : 0), (w = 0 <= w ? w : 1)),
                      c = 0;
                    c < z;
                    c++
                  )
        ...
        processData: function (b) {
          ...
          u &&
            this.sorted &&
            !n &&
            (!l || c > l || this.forceCrop) &&
            (d[c - 1] < p || d[0] > B
              ? ((d = []), (e = []))
              : this.yData &&
                (d[0] < p || d[c - 1] > B) &&
                ((f = this.cropData(this.xData, this.yData, p, B)),
                (d = f.xData),
                (e = f.yData),
                (f = f.start),
                (g = !0)));
          for (l = d.length || 1; --l; )
            (c = r ? k(d[l]) - k(d[l - 1]) : d[l] - d[l - 1]),
              0 < c && (void 0 === h || c < h) ? (h = c) : 0 > c && x && (a.error(15, !1, this.chart), (x = !1));
          this.cropped = g;
          this.cropStart = f;
        ...
        generatePoints: function () {
          ...
          for (t = 0; t < l; t++)
            (n = k + t),
              x
                ? ((p = new g().init(this, [f[t]].concat(u(c[t])))),
                  (p.dataGroup = this.groupMap[t]),
                  p.dataGroup.options &&
                    ((p.options = p.dataGroup.options), r(p, p.dataGroup.options), delete p.dataLabels))
                : (p = d[n]) || void 0 === b[n] || (d[n] = p = new g().init(this, b[n], f[t])),
              p && ((p.index = n), (B[t] = p));
          this.options.keys = a;
          if (d && (l !== (e = d.length) || x))
        ...
        getExtremes: function (a) {
          ...
          for (B = 0; B < c; B++)
            if (
              ...
              if ((u = p.length)) for (; u--; ) 'number' === typeof p[u] && (f[g++] = p[u]);
              else f[g++] = p;
          this.dataMin = k(f);
          this.dataMax = G(f);
        ...
        translate: function () {
          ...
          for (u = 0; u < k; u++) {
            ...
            d &&
              ...
              N &&
              N[I] &&
              ((H = this.getStackIndicator(H, I, this.index)),
              (V = N[I]),
              (Q = V.points[H.key]),
              (E = Q[0]),
              (Q = Q[1]),
            ...
            F.plotY = E =
              'number' === typeof Q && Infinity !== Q
                ? Math.min(Math.max(-1e5, f.translate(Q, 0, 1, 0, 1)), 1e5)
                : void 0;
        ...
        setClip: function (a) {
          var b = this.chart,
            ...
            g = c || b.clipBox,
            h =
              this.sharedClipKey || ['_sharedClip', a && a.duration, a && a.easing, g.height, d.xAxis, d.yAxis].join(),
            m = b[h],
            l = b[h + 'm'];
          m ||
            (a &&
          ...
          !1 !== d.clip &&
            (this.group.clip(a || c ? m : b.clipRect), this.markerGroup.clip(l), (this.sharedClipKey = h));
          a ||
            (m.count[this.index] && (delete m.count[this.index], --m.count.length),
            0 === m.count.length &&
              h &&
              b[h] &&
              (c || (b[h] = b[h].destroy()), b[h + 'm'] && (b[h + 'm'] = b[h + 'm'].destroy())));
        },
        animate: function (a) {
          var b = this.chart,
          ...
          a
            ...
            : ((e = this.sharedClipKey),
              (a = b[e]) && a.animate({ width: b.plotSizeX, x: 0 }, d),
              b[e + 'm'] && b[e + 'm'].animate({ width: b.plotSizeX + 99, x: 0 }, d),
              (this.animate = null));
        },
          ...
          if (!1 !== h.enabled || this._hasPointMarkers)
            for (e = 0; e < a.length; e++)
              (c = a[e]),
                ...
                (n = !1 !== c.isInside),
                f && !c.isNull
                  ? ((f = b(l.symbol, this.symbol)),
                    (r = this.markerAttribs(c, c.selected && 'select')),
                    g
                      ? g[n ? 'show' : 'hide'](!0).animate(r)
                      : n &&
                        (0 < r.width || c.hasImage) &&
                        (c.graphic = g = d.renderer.symbol(f, r.x, r.y, r.width, r.height, k ? l : h).add(u)),
                    g && !d.styledMode && g.attr(this.pointAttribs(c, c.selected && 'select')),
                    g && g.addClass(c.getClassName(), !0))
                  : g && (c.graphic = g.destroy());
        },
          ...
          a.forEach(function (g, q) {
            ...
            g.isNull && !v(b) && 0 < q
              ...
              : (0 === q || l
                  ? (q = ['M', g.plotX, g.plotY])
                  : e.getPointSpline
                  ? (q = e.getPointSpline(a, g, q))
                  : c
                  ? ((q =
                      1 === c
                        ? ['L', u.plotX, n]
                        : 2 === c
                        ? ['L', (u.plotX + k) / 2, u.plotY, 'L', (u.plotX + k) / 2, n]
                        : ['L', k, u.plotY]),
                    q.push('L', k, n))
                  : (q = ['L', k, n]),
                m.push(g.x),
                c && (m.push(g.x), 2 === c && m.push(g.x)),
                h.push.apply(h, q),
                (l = !1));
          });
          h.xMap = m;
        ...
        drawGraph: function () {
          ...
          f.forEach(function (f, c) {
            var g = f[0],
              h = a[g];
            h
              ? ((h.endX = a.preventGraphAnimation ? null : d.xMap), h.animate({ d: d }))
              : d.length &&
                ((a[g] = a.chart.renderer.path(d).addClass(f[1]).attr({ zIndex: 1 }).add(a.group)),
                e ||
                  ((h = { stroke: f[2], 'stroke-width': b.lineWidth, fill: (a.fillGraph && a.color) || 'none' }),
                  f[3]
                    ? (h.dashstyle = f[3])
                    : 'square' !== b.linecap && (h['stroke-linecap'] = h['stroke-linejoin'] = 'round'),
        ...
        applyZones: function () {
          ...
          c.length &&
            ...
            c.forEach(function (c, m) {
              ...
              w = Math.max(f, g);
              r.isXAxis
                ? ((l = { x: B ? w : E, y: 0, width: v, height: u }), t || (l.x = d.plotHeight - l.x))
                : ((l = { x: 0, y: B ? w : E, width: u, height: v }), t && (l.y = d.plotWidth - l.y));
              B &&
                e.isVML &&
                (l = r.isXAxis
                  ? { x: 0, y: p ? E : w, height: l.width, width: d.chartWidth }
                  : { x: l.y - d.plotLeft - d.spacingBox.x, y: 0, width: l.height, height: d.chartHeight });
              h[m]
                ? h[m].animate(l)
                : ((h[m] = e.clipRect(l)), k && a['zone-graph-' + m].clip(h[m]), n && a['zone-area-' + m].clip(h[m]));
              H = c.value > x.max;
        ...
        invertGroups: function (a) {
          function b() {
            ['group', 'markerGroup'].forEach(function (b) {
              d[b] &&
                (e.renderer.isVML && d[b].attr({ width: d.yAxis.len, height: d.xAxis.len }),
        ...
        redraw: function () {
          var a = this.chart,
            ...
            f = this.yAxis;
          e &&
            (a.inverted && e.attr({ width: a.plotWidth, height: a.plotHeight }),
          ...
          function b(a, e, c) {
            ...
            if ((g = a && a.length))
              return (
                ...
                (g = Math.floor(g / 2)),
                { point: a[g], left: b(a.slice(0, g), e + 1, c), right: b(a.slice(g + 1), e + 1, c) }
              );
          }
    ...
    a.StackItem.prototype = {
      ...
      render: function (a) {
        ...
        this.label
          ...
          : (this.label = c.renderer
              .text(l, null, null, e.useHTML)
              .css(e.style)
    ...
    F.prototype.getStacks = function () {
      ...
      a.series.forEach(function (c) {
        !c.options.stacking ||
          ...
          (c.stackKey = c.type + v(c.options.stack, ''));
      });
    };
      ...
      if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
        ...
        for (q = 0; q < l; q++)
          (w = c[q]),
            ...
            B[A][w] ||
              (m[A] && m[A][w]
                ? ((B[A][w] = m[A][w]), (B[A][w].total = null))
                : (B[A][w] = new a.StackItem(t, t.options.stackLabels, D, w, b))),
            (A = B[A][w]),
            null !== y
              ? ((A.points[f] = A.points[this.index] = [v(A.cumulative, g)]),
                k(A.cumulative) || (A.base = f),
                (A.touched = t.stacksTouched),
                0 < z.index && !1 === this.singleStacks && (A.points[f][0] = A.points[this.index + ',' + w + ',0'][0]))
              : (A.points[f] = A.points[this.index] = null),
            'percent' === n
              ? ((D = D ? x : u),
                p && B[D] && B[D][w]
                  ? ((D = B[D][w]), (A.total = D.total = Math.max(D.total, A.total) + Math.abs(y) || 0))
                  : (A.total = G(A.total + (Math.abs(y) || 0))))
              : (A.total = G(A.total + (y || 0))),
            (A.cumulative = v(A.cumulative, g) + (y || 0)),
            null !== y && (A.points[f].push(A.cumulative), (e[q] = A.cumulative));
      ...
      a[d + 'Stacker'] &&
        [c, '-' + c].forEach(function (c) {
          for (var b = l.length, g, h; b--; )
            if (
              ((g = l[b]), (k = a.getStackIndicator(k, g, a.index, c)), (h = (g = e[c] && e[c][g]) && g.points[k.key]))
            )
              a[d + 'Stacker'](h, g, b);
        });
    };
  ...
  (function (a) {
    ...
    w(k.prototype, {
      ...
      showLoading: function (a) {
        ...
        e ||
          ...
          (b.loadingSpan = c('span', { className: 'highcharts-loading-inner' }, null, e)),
          y(b, 'redraw', f));
        e.className = 'highcharts-loading';
        b.loadingSpan.innerHTML = a || d.lang.loading;
        b.styledMode ||
          (p(e, w(g.style, { zIndex: 10 })),
          p(b.loadingSpan, g.labelStyle),
          b.loadingShown ||
            (p(e, { opacity: 0, display: '' }),
            F(e, { opacity: g.style.opacity || 0.5 }, { duration: g.showDuration || 0 })));
        b.loadingShown = !0;
        f();
      },
        ...
        this.collectionsWithUpdate.forEach(function (a) {
          ...
          b[a] &&
            ...
            E(b[a]).forEach(function (b, f) {
              (f = (t(b.id) && m.get(b.id)) || m[a][d ? d[f] : f]) &&
                f.coll === a &&
                (f.update(b, !1), c && (f.touched = !0));
              if (!f && c)
                if ('series' === a) m.addSeries(b, !1).touched = !0;
                else if ('xAxis' === a || 'yAxis' === a) m.addAxis(b, 'xAxis' === a, !1).touched = !0;
            }),
            c &&
    ...
    w(b.prototype, {
      update: function (a, b, d, c) {
        function h() {
          ...
          e(a, !0) &&
            (l && l.element && a && a.marker && void 0 !== a.marker.symbol && (f.graphic = l.destroy()),
    ...
    w(x.prototype, {
      addPoint: function (a, b, d, e) {
        ...
        r = k.x;
        p = u.length;
        if (this.requireSorting && r < u[p - 1]) for (n = !0; p && u[p - 1] > r; ) p--;
      ...
      update: function (b, d) {
        ...
        var e = this,
          ...
          t = e.finishedAnimating && { animation: !1 },
        ...
        if (E) b.data && this.setData(b.data, !1), b.name && this.setName(b.name, !1);
          ...
          b = n(h, t, { index: e.index, pointStart: g(h.pointStart, e.xData[0]) }, { data: e.options.data }, b);
          e.remove(!1, null, !1, !0);
          ...
          var c = G.prototype.getGraphPath,
            ...
            H = function (c, h, k) {
              ...
              var p,
                ...
                m = !0;
              k || u
                ? ((p = (u ? c[0] : c[1]) + k), (f = c[0] + k), (m = !!u))
                : !v && a[h] && a[h].isNull && (p = f = b);
              void 0 !== p &&
                (l.push({ plotX: d, plotY: null === p ? x : w.getThreshold(p), isNull: m, isCliff: !0 }),
                e.push({ plotX: d, plotY: null === f ? x : w.getThreshold(f), doCurve: !1 }));
            };
          a = a || this.points;
          v && (a = this.getStackPoints(a));
          for (r = 0; r < a.length; r++)
            if (((h = a[r].isNull), (d = F(a[r].rectPlotX, a[r].plotX)), (u = F(a[r].yBottom, x)), !h || k))
              k || H(r, r - 1, 'left'),
                (h && !v && k) || (l.push(a[r]), e.push({ x: r, plotX: d, plotY: u })),
                k || H(r, r + 1, 'right');
          r = c.call(this, l, !0, !0);
          e.reversed = !0;
          h = c.call(this, e, !0, !0);
        ...
        drawGraph: function () {
          ...
          v.forEach(function (c) {
            var p = c[0],
              h = a[p];
            h
              ? ((h.endX = a.preventGraphAnimation ? null : k.xMap), h.animate({ d: k }))
              : ((h = { zIndex: 0 }),
                a.chart.styledMode || (h.fill = F(c[3], y(c[2]).setOpacity(F(t.fillOpacity, 0.75)).get())),
      ...
      {},
      {
        getPointSpline: function (a, G, k) {
          ...
          if (t && !t.isNull && !1 !== t.doCurve && !G.isCliff && k && !k.isNull && !1 !== k.doCurve && !G.isCliff) {
            ...
            h += e;
            w > a && w > p
              ? ((w = Math.max(a, p)), (h = 2 * p - w))
              : w < a && w < p && ((w = Math.min(a, p)), (h = 2 * p - w));
            h > k && h > p
              ? ((h = Math.max(k, p)), (w = 2 * p - h))
              : h < k && h < p && ((h = Math.min(k, p)), (w = 2 * p - h));
            G.rightContX = r;
            G.rightContY = h;
          }
    ...
    w(
      ...
      },
      {
          ...
          !1 === e.grouping
            ...
            : a.chart.series.forEach(function (d) {
                ...
                d.type !== a.type ||
                  ...
                  k.pos !== c.pos ||
                  (e.stacking
                    ? ((g = d.stackKey), void 0 === b[g] && (b[g] = p++), (h = b[g]))
                    : !1 !== e.grouping && (h = p++),
                  (d.columnIndex = h));
              });
          var u = Math.min(
              Math.abs(c.transA) * (c.ordinalSlope || e.pointRange || c.closestPointRange || c.tickInterval || 1),
              c.len
            ),
            r = u * e.groupPadding,
            v = (u - 2 * r) / (p || 1),
        ...
        translate: function () {
          ...
          a.points.forEach(function (c) {
            ...
            c.tooltipPos = e.inverted
              ? [d.len + d.pos - e.plotLeft - l, a.xAxis.len - f - n / 2, v]
              : [f + n / 2, l + d.pos - e.plotTop, v];
        ...
        pointAttribs: function (a, e) {
          ...
          e &&
            ((a = p(c.states[e], (a.options.states && a.options.states[e]) || {})),
            (e = a.brightness),
        ...
        drawPoints: function () {
          ...
          a.points.forEach(function (b) {
            ...
            if (c(b.plotY) && null !== b.y) {
              ...
              e.styledMode ||
                h[l](a.pointAttribs(b, b.selected && 'select')).shadow(k.shadow, null, k.stacking && !k.borderRadius);
    ...
    F(
      ...
      },
      {
        ...
        applyJitter: function () {
          ...
          k &&
            this.points.forEach(function (p, t) {
  ...
  (function (a) {
    ...
    a.CenteredSeriesMixin = {
      ...
      getStartAndEndRadians: function (a, k) {
        ...
        return { start: y * (a + -90), end: y * (k + -90) };
      },
    };
  })(I);
  (function (a) {
      ...
      },
      {
          ...
          a ||
            (c.forEach(function (a) {
              var b = a.graphic,
                c = a.shapeArgs;
              b &&
                (b.attr({ r: a.startR || e.center[3] / 2, start: d, end: d }),
        ...
        getX: function (a, c, h) {
          ...
          return (
            d[0] +
            (c ? -1 : 1) *
              Math.cos(Math.asin(Math.max(Math.min((a - d[1]) / (e + h.labelDistance), 1), -1))) *
              (e + h.labelDistance) +
            (0 < h.labelDistance ? (c ? -1 : 1) * this.options.dataLabels.padding : 0)
          );
        },
        translate: function (a) {
          ...
          for (w = 0; w < A; w++) {
            ...
            f.slicedTranslation = { translateX: Math.round(Math.cos(k) * d), translateY: Math.round(Math.sin(k) * d) };
            v = (Math.cos(k) * a[2]) / 2;
            m = (Math.sin(k) * a[2]) / 2;
            f.tooltipPos = [a[0] + 0.7 * v, a[1] + 0.7 * m];
            f.half = k < -Math.PI / 2 || k > Math.PI / 2 ? 1 : 0;
            f.angle = k;
            b = Math.min(g, f.labelDistance / 5);
            f.labelPosition = {
              natural: { x: a[0] + v + Math.cos(k) * f.labelDistance, y: a[1] + m + Math.sin(k) * f.labelDistance },
              final: {},
        ...
        drawPoints: function () {
          ...
          a.points.forEach(function (e) {
            ...
            if (e.isNull) g && (e.graphic = g.destroy());
              ...
              g
                ? (g.setRadialReference(a.center), c.styledMode || g.attr(b), g.animate(k(p, d)))
                : ((e.graphic = g = h[e.shapeType](p).setRadialReference(a.center).attr(d).add(a.group)),
        ...
        connectorShapes: {
          fixedOffset: function (a, c, h) {
            ...
            return ['M', a.x, a.y]
              .concat(
                h.softConnector
                  ? ['C', a.x + ('left' === a.alignment ? -5 : 5), a.y, 2 * d.x - c.x, 2 * d.y - c.y, d.x, d.y]
                  : ['L', d.x, d.y]
              )
              .concat(['L', c.x, c.y]);
          },
  ...
  (function (a) {
    ...
    a.distribute = function (d, c, b) {
      ...
      d.some(function (d) {
        var e = 0;
        if (
          d.targets.some(function () {
            l[h].pos = d.pos + e;
            if (Math.abs(l[h].pos - l[h].target) > b)
              return (
                l.slice(0, h + 1).forEach(function (a) {
                  delete a.pos;
                }),
                (l.reducedLen = (l.reducedLen || c) - 0.1 * c),
                l.reducedLen > 0.1 * c && a.distribute(l, c, b),
                !0
              );
            e += l[h].size;
            h++;
    ...
    r.prototype.drawDataLabels = function () {
      ...
      function e(a, b) {
        ...
        else if (l(a) || l(b)) for (c = Math.max(a.length, b.length); c--; ) d[c] = p(a[c], b[c]);
        else d = p(a, b);
        return d;
      }
      var b = this,
        ...
        r = e(
          e(
            h.options.plotOptions && h.options.plotOptions.series && h.options.plotOptions.series.dataLabels,
            h.options.plotOptions && h.options.plotOptions[b.type] && h.options.plotOptions[b.type].dataLabels
          ),
          r
        );
          ...
          t.forEach(function (f) {
            ...
            w.forEach(function (e, g) {
              ...
              m &&
                ...
                (q = e.rotation),
                h.styledMode ||
                  ((n.color = v(e.color, n.color, b.color, '#000000')),
                  'contrast' === n.color &&
                    ((f.contrastColor = A.getContrast(f.color || b.color)),
                    (n.color =
                      e.inside || 0 > v(e.distance, f.labelDistance) || k.stacking ? f.contrastColor : '#000000')),
                  k.cursor && (n.cursor = k.cursor)),
                (u = { r: e.borderRadius || 0, rotation: q, padding: e.padding, zIndex: 1 }),
                h.styledMode ||
                  ((u.fill = e.backgroundColor), (u.stroke = e.borderColor), (u['stroke-width'] = e.borderWidth)),
              ...
              !p || (m && G(l))
                ? m &&
                  ...
                  (p
                    ...
                    : ((f.dataLabels = f.dataLabels || []),
                      (p = f.dataLabels[g] = q
                        ? A.text(l, 0, -9999).addClass('highcharts-data-label')
                        : A.label(l, 0, -9999, e.shape, null, null, e.useHTML, null, 'data-label')),
                      g || (f.dataLabel = p),
                      p.addClass(
                ...
                : ((f.dataLabel = f.dataLabel && f.dataLabel.destroy()),
                  ...
                  r &&
                    ((f.connector = f.connector.destroy()),
    ...
    r.prototype.alignDataLabel = function (a, e, b, c, h) {
      var d = this.chart,
        ...
        q =
          this.visible &&
          (a.series.forceDL ||
            d.isInsidePlot(l, Math.round(m), g) ||
            (c && d.isInsidePlot(l, g ? c.x + 1 : c.y + c.height - 1, g))),
        r = 'justify' === v(b.overflow, 'justify');
      if (
        q &&
        ((u = d.renderer.fontMetrics(d.styledMode ? void 0 : b.style.fontSize, e).b),
        (c = k({ x: g ? this.yAxis.len - m : l, y: Math.round(g ? this.xAxis.len - l : m), width: 0, height: 0 }, c)),
        k(b, { width: n.width, height: n.height }),
        p
          ? ((r = !1),
            (l = d.renderer.rotCorr(u, p)),
            (l = {
              x: c.x + b.x + c.width / 2 + l.x,
              y: c.y + b.y + { top: 0, middle: 0.5, bottom: 1 }[b.verticalAlign] * c.height,
            }),
            e[h ? 'attr' : 'animate'](l).attr({ align: f }),
            (m = (p + 720) % 360),
            (m = 180 < m && 360 > m),
            'left' === f
              ? (l.y -= m ? n.height : 0)
              : 'center' === f
              ? ((l.x -= n.width / 2), (l.y -= n.height / 2))
              : 'right' === f && ((l.x -= n.width), (l.y -= m ? 0 : n.height)),
            (e.placed = !0),
            (e.alignAttr = l))
          : (e.align(b, null, c), (l = e.alignAttr)),
        r && 0 <= c.height
          ? (a.isLabelJustified = this.justifyDataLabel(e, b, l, n, c, h))
          : v(b.crop, !0) && (q = d.isInsidePlot(l.x, l.y) && d.isInsidePlot(l.x + n.width, l.y + n.height)),
        b.shape && !p)
      )
        e[h ? 'attr' : 'animate']({
    ...
    h.pie &&
      ((h.pie.prototype.dataLabelPositioners = {
              ...
              (a.visible
                ? (R[a.half].push(a),
                  ...
                  !G(h.style.width) &&
                    ...
                    a.dataLabel.getBBox().width > t &&
                    (a.dataLabel.css({ width: 0.7 * t }), (a.dataLabel.shortened = !0)))
              ...
              for (
                d.sortByAngle(e, g - 0.5),
                  0 < d.maxLabelDistance &&
                    ((l = Math.max(0, y - q - d.maxLabelDistance)),
                    (u = Math.min(y + q + d.maxLabelDistance, c.plotHeight)),
                    e.forEach(function (a) {
                      0 < a.labelDistance &&
                        a.dataLabel &&
                        ((a.top = Math.max(0, y - q - a.labelDistance)),
                        (a.bottom = Math.min(y + q + a.labelDistance, c.plotHeight)),
                        (x = a.dataLabel.getBBox().height || 21),
                        (a.distributeBox = { target: a.labelPosition.natural.y - a.top + x / 2, size: x, rank: a.y }),
                ...
                t &&
                  G(b.distributeBox) &&
                  (void 0 === b.distributeBox.pos
                    ? (N = 'hidden')
                    : ((M = b.distributeBox.size), (P = W.radialDistributionY(b))));
                ...
                v(h.crop, !0) &&
                  ...
                  (l = null),
                  C - I < k && 1 === g
                    ? ((l = Math.round(I - C + k)), (O[3] = Math.max(l, O[3])))
                    : C + I > n - k && 0 === g && ((l = Math.round(C + I - n + k)), (O[1] = Math.max(l, O[1]))),
                  0 > P - M / 2
                    ? (O[0] = Math.max(Math.round(-P + M / 2), O[0]))
                    : P + M / 2 > m && (O[2] = Math.max(Math.round(P + M / 2 - m), O[2])),
                  (K.sideOverflow = l));
              }
          }),
              ...
              if ((K = a.dataLabel) && K._pos && a.visible && 0 < a.labelDistance) {
                ...
                if ((b = !w))
                  (a.connector = w = c.renderer
                    ...
                    c.styledMode || w.attr({ 'stroke-width': l, stroke: h.connectorColor || a.color || '#666666' });
      ...
      (h.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        k ||
          (null !== e[0]
            ? (h = Math.max(d[2] - Math.max(a[1], a[3]), c))
            : ((h = Math.max(d[2] - a[1] - a[3], c)), (d[0] += (a[3] - a[1]) / 2)),
          null !== e[1]
            ? (h = Math.max(Math.min(h, d[2] - Math.max(a[0], a[2])), c))
            : ((h = Math.max(Math.min(h, d[2] - a[0] - a[2]), c)), (d[1] += (a[0] - a[2]) / 2)),
          h < d[2]
            ? ((d[2] = h),
    ...
    h.column &&
      (h.column.prototype.alignDataLabel = function (a, e, b, c, h) {
        ...
        k &&
          ((c = p(k)),
          0 > c.y && ((c.height += c.y), (c.y = 0)),
          (k = c.y + c.height - g.yAxis.len),
          0 < k && (c.height -= k),
          d &&
            (c = { x: g.yAxis.len - c.y - c.height, y: g.xAxis.len - c.x - c.width, width: c.height, height: c.width }),
  ...
  (function (a) {
    ...
    c(y, 'render', function () {
      ...
      (this.series || []).forEach(function (c) {
        ...
        c.visible &&
          (!1 !== p.enabled || c._hasPointLabels) &&
          c.points.forEach(function (c) {
            c.visible &&
              (F(c.dataLabels) ? c.dataLabels : c.dataLabel ? [c.dataLabel] : []).forEach(function (h) {
                var e = h.options;
    ...
    y.prototype.hideOverlappingLabels = function (a) {
      ...
      l = function (a) {
        ...
        if (a && (!a.alignAttr || a.placed))
          return (
            ...
            (c = a.parentGroup),
            a.width ||
              ((d = a.getBBox()), (a.width = d.width), (a.height = d.height), (d = r.fontMetrics(null, a.element).h)),
            {
      ...
      for (e = 0; e < k; e++)
        for (g = (l = a[e]) && l.absoluteBox, h = e + 1; h < k; ++h)
          if (
            ((d = (n = a[h]) && n.absoluteBox),
            g &&
              d &&
              l !== n &&
              0 !== l.newOpacity &&
              0 !== n.newOpacity &&
              (d = b(g.x, g.y, g.width, g.height, d.x, d.y, d.width, d.height)))
          )
          ...
          a.oldOpacity !== d &&
            (a.alignAttr && a.placed
              ? (d
                ...
                p(c, 'afterHideOverlappingLabels'))
              : a.attr({ opacity: d })),
          (a.isOld = !0));
      });
    };
    ...
    x = a.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        var a = this,
          ...
          t = 'rgba(192,192,192,' + (b ? 0.0001 : 0.002) + ')';
        if (g && !d)
          for (p = g + 1; p--; )
      ...
      showResetZoom: function () {
        ...
        v(this, 'beforeShowResetZoom', null, function () {
          b.resetZoomButton = b.renderer
            .button(d.resetZoom, null, null, a, g, h && h.hover)
        ...
        v(this, 'pan', { originalEvent: a }, function () {
          ...
          ('xy' === b ? [1, 0] : [1]).forEach(function (b) {
            ...
            b.series.length &&
              f !== l.min &&
              m !== l.max &&
              (b.setExtremes(f, m, !1, !1, { trigger: 'pan' }), (e = !0));
            c[d] = g;
          });
          e && c.redraw(!1);
        ...
        if (
          ...
          if (this.graphic)
            ...
            if (a && f) {
              ...
              if (r) r[b ? 'animate' : 'attr']({ x: y.x, y: y.y });
              else
                h &&
                  ((e.stateMarkerGraphic = r = w.renderer.symbol(h, y.x, y.y, y.width, y.height).add(e.markerGroup)),
                  (r.currentSymbol = h));
          ...
          (c = g.halo) && c.size
            ? (x || (e.halo = x = w.renderer.path().add((this.graphic || r).parentGroup)),
              x.show()[b ? 'animate' : 'attr']({ d: this.haloPath(c.size) }),
              x.attr({
                class:
                  'highcharts-halo highcharts-color-' +
                  l(this.colorIndex, e.colorIndex) +
                  (this.className ? ' ' + this.className : ''),
                zIndex: -1,
              }),
              (x.point = this),
              w.styledMode || x.attr(t({ fill: this.color || e.color, 'fill-opacity': c.opacity }, c.attributes)))
            : x && x.point && x.point.haloPath && x.animate({ d: x.point.haloPath(0) }, null, x.hide);
          this.state = a;
    ...
    t(d.prototype, {
      ...
      setState: function (a) {
        ...
        if (
          ...
          (b.state = a),
          !(b.chart.styledMode || (e[a] && !1 === e[a].enabled)) &&
            (a && (g = e[a].lineWidth || g + (e[a].lineWidthPlus || 0)), d && !d.dashstyle))
        )
          for (
            g = { 'stroke-width': g },
              d.animate(g, l(e[a || 'normal'] && e[a || 'normal'].animation, b.chart.options.chart.animation));
            b['zone-graph-' + c];
  ...
  (function (a) {
    ...
    y.prototype.setResponsive = function (c, k) {
      ...
      t = t.toString() || void 0;
      t !== (r && r.ruleIds) &&
        (r && this.update(r.undoOptions, c),
        t
          ? ((r = this.currentOptions(k)),
            (r.isResponsiveOptions = !0),
            (this.currentResponsive = { ruleIds: t, mergedOptions: k, undoOptions: r }),
            this.update(k, c))
    ...
    y.prototype.matchResponsiveRule = function (a, c) {
      ...
      (
        ...
        function () {
          return (
            this.chartWidth <= k(p.maxWidth, Number.MAX_VALUE) &&
            this.chartHeight <= k(p.maxHeight, Number.MAX_VALUE) &&
            this.chartWidth >= k(p.minWidth, 0) &&
            this.chartHeight >= k(p.minHeight, 0)
          );
        }
      ...
      function p(k, r, h, e) {
        ...
        a.objectEach(k, function (a, d) {
          if (!e && -1 < ['series', 'xAxis', 'yAxis'].indexOf(d))
            for (a = c(a), h[d] = [], l = 0; l < a.length; l++)
