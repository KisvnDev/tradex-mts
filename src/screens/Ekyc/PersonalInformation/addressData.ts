export const addressData = [
  ...
  },
  {
    quan: [
      ...
      { phuong: ['Phường Sông Đà', 'Phường Na Lay', 'Xã Lay Nưa'], name: 'Thị Xã Mường Lay' },
      {
        phuong: [
          'Xã Sín Thầu',
          'Xã Sen Thượng',
  ...
  },
  {
    quan: [
      ...
      { phuong: ['Thị trấn Cô Tô', 'Xã Đồng Tiến', 'Xã Thanh Lân'], name: 'Huyện Cô Tô' },
    ],
  ...
  },
  {
    quan: [
      ...
      { phuong: [], name: 'Huyện Bạch Long Vĩ' },
    ],
  ...
  },
  {
    quan: [
      ...
      { phuong: ['Phường 1', 'Phường An Đôn', 'Phường 2', 'Phường 3', 'Xã Hải Lệ'], name: 'Thị xã Quảng Trị' },
      {
        phuong: [
          'Thị trấn Hồ Xá',
          'Thị trấn Bến Quan',
  ...
  },
  {
    quan: [
      ...
      { phuong: ['Phường Mỹ An', 'Phường Khuê Mỹ', 'Phường Hoà Quý', 'Phường Hoà Hải'], name: 'Quận Ngũ Hành Sơn' },
      {
        phuong: [
          'Phường Khuê Trung',
          'Phường Hòa Phát',
  ...
  },
  {
    quan: [
      ...
      {
        phuong: ['Xã Quế Trung', 'Xã Ninh Phước', 'Xã Phước Ninh', 'Xã Quế Lộc', 'Xã Sơn Viên', 'Xã Quế Lâm'],
        name: 'Huyện Nông Sơn',
      },
    ],
    city: 'Tỉnh Quảng Nam',
  },
  {
    quan: [
      ...
      { phuong: ['Xã Long Sơn', 'Xã Long Mai', 'Xã Thanh An', 'Xã Long Môn', 'Xã Long Hiệp'], name: 'Huyện Minh Long' },
      {
        phuong: [
          'Thị trấn Chợ Chùa',
          'Xã Hành Thuận',
  ...
  },
  {
    quan: [
      ...
      { phuong: ['Thị trấn Trường Sa', 'Xã Song Tử Tây', 'Xã Sinh Tồn'], name: 'Huyện Trường Sa' },
    ],
    city: 'Tỉnh Khánh Hòa',
  },
  {
    quan: [
      ...
      {
        phuong: ['Xã Phước Chiến', 'Xã Công Hải', 'Xã Phước Kháng', 'Xã Lợi Hải', 'Xã Bắc Sơn', 'Xã Bắc Phong'],
  ...
  },
  {
    quan: [
      ...
      { phuong: ['Xã Ngũ Phụng', 'Xã Long Hải', 'Xã Tam Thanh'], name: 'Huyện Phú Quí' },
    ],
  ...
  },
  {
    quan: [
      ...
      { phuong: ['Xã Ia Đal', 'Xã Ia Dom', 'Xã Ia Tơi'], name: "Huyện Ia H' Drai" },
    ],
    city: 'Tỉnh Kon Tum',
  },
  {
  ...
  },
  {
    quan: [
      ...
      {
        phuong: ['Xã Krông Na', 'Xã Ea Huar', 'Xã Ea Wer', 'Xã Tân Hoà', 'Xã Cuôr KNia', 'Xã Ea Bar', 'Xã Ea Nuôl'],
        name: 'Huyện Buôn Đôn',
      },
      {
        phuong: [
      ...
      {
        phuong: ['Xã Cư Né', 'Xã Chư KBô', 'Xã Cư Pơng', 'Xã Ea Sin', 'Xã Pơng Drang', 'Xã Tân Lập', 'Xã Ea Ngai'],
  ...
  },
  {
    quan: [
      ...
      {
        phuong: ['Xã Quảng Trực', 'Xã Đắk Búk So', 'Xã Quảng Tâm', "Xã Đắk R'Tíh", 'Xã Đắk Ngo', 'Xã Quảng Tân'],
        name: 'Huyện Tuy Đức',
      },
    ],
    city: 'Tỉnh Đắk Nông',
  },
  {
    quan: [
      ...
      {
        phuong: ['Thị trấn Lạc Dương', 'Xã Đạ Chais', 'Xã Đạ Nhim', 'Xã Đưng KNớ', 'Xã Lát', 'Xã Đạ Sar'],
  ...
  },
  {
    quan: [
      ...
      {
        phuong: ['Xã Tân Thới', 'Xã Tân Phú', 'Xã Phú Thạnh', 'Xã Tân Thạnh', 'Xã Phú Đông', 'Xã Phú Tân'],
  ...
  },
  {
    quan: [
      ...
      { phuong: ['Xã Hòn Tre', 'Xã Lại Sơn', 'Xã An Sơn', 'Xã Nam Du'], name: 'Huyện Kiên Hải' },
      {
        phuong: ['Xã Thạnh Yên', 'Xã Thạnh Yên A', 'Xã An Minh Bắc', 'Xã Vĩnh Hòa', 'Xã Hoà Chánh', 'Xã Minh Thuận'],
        name: 'Huyện U Minh Thượng',
      },
      {
        phuong: ['Xã Vĩnh Phú', 'Xã Vĩnh Điều', 'Xã Tân Khánh Hòa', 'Xã Phú Lợi', 'Xã Phú Mỹ'],
...
export interface IEkycCityData {
  quan: {
    phuong: string[];
    name: string;
  }[];
...
export interface IEkycDistrictData {
  phuong: string[];
  name: string;
}
