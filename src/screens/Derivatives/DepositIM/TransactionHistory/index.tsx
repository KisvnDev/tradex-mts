...
import { queryDepositIMTransactionHistory } from './actions';
...
interface ITransactionHistoryProps extends React.ClassAttributes<TransactionHistory>, WithTranslation {
  ...
  queryDepositIMTransactionHistory(params: IObject): void;
}
...
class TransactionHistory extends React.Component<ITransactionHistoryProps, ITransactionHistoryState> {
  ...
  private requestData = (loadMore = false) => {
    ...
    config.usingNewKisCore && (params.transferType = 'VSD_DEPOSIT');

    this.props.queryDepositIMTransactionHistory(params);
  };
...
const mapStateToProps = (state: IState) => ({
  ...
  transactionHistory: state.derivativesDepositIMTransactionHistory,
...
export default withErrorBoundary(
  withTranslation()(
    connect(mapStateToProps, {
      queryDepositIMTransactionHistory,
    })(TransactionHistory)
  ),
  Fallback,
  handleError
