...
#ifndef FINALSDK_SWIFT_H
#define FINALSDK_SWIFT_H
...
@property (nonatomic) BOOL isTrackingFace;
...
@property (nonatomic, copy) NSString * _Nonnull linkAddFace;
@property (nonatomic, copy) NSString * _Nonnull linkVerifyFace;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
